  ...
  demo: {
    ...
    sections: [
      ...
      },
      {
        ...
        h2: "Direct routing.",
        deck: "We reply within one business day. If procurement runs on MSAs and License agreements, ping enterprise directly and we&rsquo;ll route.",
      },
    ],
  },
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { title: "GDPR + CCPA + state-privacy regimes", body: "Nebbos is infrastructure the customer runs — customer data never touches Nebbos servers, so the classical processor-controller frame does not apply. The narrow platform-account metadata Nebbos does hold (login email, session cookies) is governed by the Privacy Policy at /legal/privacy. Data-subject rights (access, correction, deletion, portability) implemented as first-class flows. Narrow-scope DPA available on request at /legal/dpa." },
        ],
      },
      {
        id: "reach",
      ...
      },
      {
        ...
        items: [
          ...
          { title: "Legal — License, MSA, Responsible Disclosure" },
  ...
  security: {
    ...
    sections: [
      ...
      },
      {
        id: "sub-processors",
        kind: "list-numbered",
        eyebrow: "10 · Infrastructure vendors (narrow scope)",
        h2: "Infrastructure vendors Nebbos operates on.",
        deck: "Customer data does not run on Nebbos servers — Cradle on customer desk, MCP on customer host, keys on customer biometric. The vendors below cover only nebbos.ai platform-account operation (login, session cookies, transactional email, checkout when self-serve lands). None touch customer Pearl memory, operator tool-call payloads, department data, or credentials. Notice of change to enterprise customers 30 days in advance. Full list at /legal/subprocessors.",
        items: [
          { title: "Hyperscaler infrastructure provider", body: "Hosting for the nebbos.ai marketing site and platform-account API. US + EU regions. SOC 2, ISO 27001, FedRAMP where applicable." },
          { title: "Identity provider", body: "WorkOS for platform login and SSO. Handles work-email authentication for the nebbos.ai admin surface only — never mediates customer operator tool calls. SOC 2." },
          { title: "Transactional email provider", body: "Demo confirmations, account emails, incident notification. Subject + timestamp visibility only. SOC 2." },
          { title: "Observability provider", body: "Metrics + tracing + logs for the platform-account API. Does not receive Cradle or MCP telemetry. SOC 2, ISO 27001." },
          { title: "Payment provider", body: "Checkout for the self-serve tier (when it lands). Billing name + address, card last-four, receipt records. PCI DSS Level 1." },
        ],
      },
      {
        id: "certs",
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { title: "GDPR (EU clients + EU data subjects)", body: "Nebbos is infrastructure the customer runs — customer Pearl memory, operator tool-call payloads, and department data never touch Nebbos servers, so the classical Article 28 processor relationship does not apply to that scope. GDPR obligations narrow to platform-account metadata (login email, session cookies), governed by the Privacy Policy at /legal/privacy. Data-subject rights (access, correction, deletion, portability) implemented as first-class flows. Narrow-scope Standard Contractual Clauses addendum available on request at /legal/dpa." },
      ...
      },
      {
        ...
        body: "Nebbos is infrastructure the customer runs. Customer Pearl memory, operator tool-call payloads, and department data live on the customer's Cradle, are mediated by the customer's MCP, and are encrypted with keys derived from the customer's biometric — they never touch Nebbos servers. The classical Article 28 processor relationship does not apply to that scope; Nebbos is closer to a database engine or hosting platform than to a SaaS data processor. Where GDPR obligations do apply is the narrow platform-account metadata Nebbos does hold to run the marketing site and the platform-account API: login email, organization name, session cookies, product-usage analytics on nebbos.ai. That scope is governed by the Privacy Policy at /legal/privacy. Standard Contractual Clauses for international transfers of that narrow scope are available where relevant. Data-subject rights (Articles 12-22: access, rectification, erasure, restriction, portability, objection) are implemented as first-class client-admin flows — rights requests do not require a support ticket. For California residents under CCPA + CPRA, consumer rights (know, delete, correct, opt-out of sale/share, limit sensitive-data use) are implemented via the same flows. State-privacy regimes (VA CDPA, CO CPA, CT CTDPA, UT CPA, and subsequent states) are covered under a unified rights-handling architecture. If your procurement team requires a Data Processing Addendum specifically for the narrow platform-metadata scope above, Nebbos will counter-sign one — see /legal/dpa.",
      },
      {
        id: "layers",
        kind: "list-numbered",
      ...
      },
      {
        ...
        items: [
          ...
          { title: "What sub-processors do you use?", body: "Customer Pearl memory, tool-call payloads, and department data never touch third-party sub-processors — that data runs on the customer's Cradle. The narrow platform-account metadata scope (hosting, identity, transactional email, observability, payment for the self-serve tier when it lands) is disclosed at /security §10 and /legal/subprocessors. Changes to that narrow-scope vendor list carry 30-day advance notice to enterprise customers." },
      ...
      },
      {
        ...
        items: [
          ...
          { title: "Security — technical controls in depth" },
          { title: "Legal — License, MSA, Responsible Disclosure, Mutual NDA" },
        ...
        id: "cta",
        kind: "cta-full-bleed",
        h2: "Request an attestation or a narrow-scope DPA (account-metadata only).",
        imageFamily: "concept-audit-attestation",
