...
export const PAGES = {
  ...
  "legal/privacy": {
    ...
    metaDescription: "How Nebbos collects, uses, retains, and returns customer data. Dual-controller structure for US and EU customers.",
    sections: [
      {
        id: "hero",
        kind: "hero-paper",
        eyebrow: "00 · Draft — pending counsel review",
        h1: "Privacy Policy",
        deck: "How Nebbos collects, uses, retains, and returns customer data. The short version: client data belongs to the client, is portable to the client, is never shared across clients, and is never used to train shared models without explicit opt-in.",
      },
      {
        id: "status",
        kind: "text-block",
        eyebrow: "01 · Draft status",
        h2: "This document is a draft pending counsel review.",
        body: "Nebbos publishes this Privacy Policy under the 24-hour manual counsel-SLA path ratified in the request-lifecycle convention. The substance and structure reflect Nebbos&rsquo;s current data-handling posture and are ready to serve buyer review, technical due-diligence, and privacy-impact assessment. Formal counsel sign-off is pending and will render the equivalent contract-binding version, filed to the same URL. Material changes between this draft and the counsel-signed version will be summarized in a change-log at the foot of the page and notified through the notification channel configured in the MSA to enterprise customers whose active engagement references this document.",
      },
      {
        id: "who",
        kind: "text-block",
        eyebrow: "02 · Who processes your data",
        h2: "The two controllers.",
        body: "Nebbos AI, a business unit of Nebbos Technologies Corp registered in Wilmington, Delaware and operating from Los Angeles, California, is the data controller for customer data originating from customers whose contracting entity sits in the United States, Canada, the United Kingdom, or any jurisdiction outside the European Economic Area, the United Kingdom, or Switzerland. Nebbos D.O.O., registered in Beograd, Serbia, is the data controller for customer data originating from customers whose contracting entity sits in the European Economic Area, the United Kingdom, or Switzerland. Each controller operates the Nebbos platform under identical technical safeguards; the distinction sits at the contracting layer and determines which supervisory authority, which legal bases, and which cross-border transfer instrument governs a given customer&rsquo;s data. Every reference to &lsquo;Nebbos&rsquo; in this policy resolves to the controller responsible for your contracting entity.",
      },
      {
        id: "collect",
        kind: "list-numbered",
        eyebrow: "03 · What data Nebbos collects",
        h2: "What Nebbos collects, broken out by service.",
        items: [
          { title: "Platform data — what your operators create", body: "Documents, events, transactions, memos, and any file, message, or record your operators load into or generate inside the Nebbos platform. Nebbos stores this as client-owned data under Layer 01 · Data with row-level isolation." },
          { title: "Pearl inference data — reasoning traces + outputs", body: "Every proposal, draft, plan, and reasoning trace produced by a Pearl on your behalf. Retained on your client&rsquo;s storage under your control; portable on request." },
          { title: "Approval and identity data", body: "Named human identity, timestamp, and context for every consequential action approved through Layer 11. Stored to the attestation trail; retained for the duration of the audit-record retention policy configured for your client." },
          { title: "Authentication and account data", body: "Email address, name, role, SSO identifier, and hardware-attestation records tied to registered credentials. Held under Layer 02 · Identity for the duration of the account plus a defined retention tail after departure." },
          { title: "Telemetry — operational metrics", body: "Aggregate service metrics — request rates, error rates, latency percentiles — without personal identifiers or client content. Used to run the platform, never sold, never used for cross-client analysis." },
          { title: "Support data", body: "Correspondence with the Nebbos support desk, product feedback, and any diagnostics you elect to share when investigating an incident. Held only as long as needed to resolve the issue." },
          { title: "Marketing and website data", body: "If you complete a form on nebbos.ai — a demo request, a newsletter subscription, an enterprise inquiry — Nebbos processes the identifiers you provide. Cookies used on the marketing site are enumerated at /legal/cookies." },
        ],
      },
      {
        id: "how",
        kind: "text-block",
        eyebrow: "04 · How Nebbos uses it",
        h2: "The uses are narrow, named, and stable.",
        body: "Nebbos processes platform data to deliver the platform your contract entitles you to — running Pearls on your behalf, storing your data on your client, producing the audit trail, and honoring approval routes you configure. Nebbos processes identity and account data to authenticate your operators and enforce the tier gate that determines which actions are available under which credential. Nebbos processes telemetry data to run the service reliably and to identify outages, regressions, and abuse. Nebbos processes support data to resolve the specific incident you report. No customer content is used to train models offered to other customers unless a customer signs an explicit opt-in agreement authorizing that use for the specific corpus and the specific model. There is no dark-pattern default setting that opts customers into training; the default is off.",
      },
      {
        id: "bases",
        kind: "list-numbered",
        eyebrow: "05 · Legal bases",
        h2: "The legal bases Nebbos relies on.",
        items: [
          { title: "GDPR Article 6(1)(b) — performance of contract", body: "Processing customer data to deliver the platform under the MSA between Nebbos and the customer, and the DPA that governs personal-data handling within that contract." },
          { title: "GDPR Article 6(1)(f) — legitimate interests", body: "Aggregate telemetry, security-event detection, fraud prevention, and platform reliability engineering, balanced against the data subject&rsquo;s rights and interests." },
          { title: "GDPR Article 6(1)(c) — legal obligation", body: "Retention of records required by tax, corporate, employment, and export-control law; response to lawful process; regulatory reporting." },
          { title: "GDPR Article 6(1)(a) — consent", body: "Marketing communications, product research invitations, and any optional feature that requires opt-in — including any use of customer data for model training." },
          { title: "California Consumer Privacy Act (CCPA/CPRA)", body: "California residents have the right to know, delete, correct, and opt out of sale or sharing. Nebbos does not sell personal information and does not share personal information for cross-context behavioral advertising." },
          { title: "EU AI Act Annex IV Section 11 — record-keeping", body: "The append-only audit trail satisfies Article 12 record-keeping obligations for high-risk AI systems and supports the technical-documentation obligations under Article 11. The trail is not a legal basis for processing personal data; it is a control that makes processing accountable. See /compliance for status." },
        ],
      },
      {
        id: "subs",
        kind: "text-block",
        eyebrow: "06 · Sub-processors",
        h2: "Sub-processors are enumerated and change on notice.",
        body: "Nebbos uses a defined list of sub-processors to deliver the platform — cloud hosting, LLM providers, observability, security tooling, transactional email. The full list, each sub-processor&rsquo;s purpose, and the transfer instrument that applies is published at /legal/subprocessors. Nebbos serves 30 calendar days&rsquo; advance notice of new sub-processors to enterprise customers via the notification channel configured in the MSA. Customers who object during the notice window may terminate the affected service without penalty per the DPA at /legal/dpa.",
      },
      {
        id: "rights",
        kind: "list-numbered",
        eyebrow: "07 · Data-subject rights",
        h2: "Rights every data subject holds.",
        items: [
          { title: "Right of access", body: "You may request a copy of the personal data Nebbos holds about you. Where Nebbos processes your data on behalf of a customer, we route the request to that customer as the controller of record for the platform-content layer." },
          { title: "Right to rectification", body: "You may request correction of inaccurate personal data. Corrections propagate through the substrate on the next storage cycle." },
          { title: "Right to erasure", body: "You may request deletion of your personal data, subject to legal retention obligations. Erasure requests against customer-controlled content route to the customer." },
          { title: "Right to restrict processing", body: "You may request that Nebbos limit processing to storage while a dispute over accuracy or legal basis is resolved." },
          { title: "Right to data portability", body: "You may receive personal data you provided in a structured, machine-readable format and transmit it to another controller. Customer-content export runs on every deploy; individual-data export routes through the DPA request path." },
          { title: "Right to object", body: "You may object to processing based on legitimate interests. Nebbos ceases that processing unless we demonstrate compelling legitimate grounds that override your rights." },
          { title: "Right not to be subject to solely automated decisions", body: "Every consequential decision inside Nebbos flows through Layer 11 · Approval and carries a named human authorization. There is no configuration option that removes this step." },
          { title: "How to exercise", body: "Route data-subject-access requests to privacy@nebbos.ai. Nebbos acknowledges within one business day and completes within statutory windows (30 calendar days under GDPR; 45 calendar days under CCPA, extendable to 90 with notice)." },
        ],
      },
      {
        id: "transfers",
        kind: "text-block",
        eyebrow: "08 · International transfers",
        h2: "How international transfers are governed.",
        body: "Personal data controlled by Nebbos D.O.O. remains within the European Economic Area unless a transfer is necessary to operate the platform. Where transfer is necessary — for example, to a US-based sub-processor — Nebbos relies on the European Commission&rsquo;s 2021 Standard Contractual Clauses (Commission Implementing Decision (EU) 2021/914) in the module appropriate to the transfer, supplemented by a Transfer Impact Assessment against the destination jurisdiction and by supplementary measures where the destination is judged high-risk. Personal data controlled by Nebbos AI in the United States that involves transfer of EEA-origin data relies on the EU-US Data Privacy Framework where the recipient is certified, or on SCCs where it is not. Onward transfers by sub-processors are constrained by back-to-back SCC obligations in the sub-processor DPA.",
      },
      {
        id: "retention",
        kind: "text-block",
        eyebrow: "09 · Retention",
        h2: "How long Nebbos keeps data.",
        body: "Customer content — platform data, Pearl inference data, approval records — is retained under the retention policy the customer configures for their client, defaulting to the term of the contract plus the offboarding window agreed in the MSA. On offboarding the customer receives a full export in machine-readable format followed by a documented deletion routine and a certificate of destruction. Identity and account data is retained for the account&rsquo;s lifetime plus a defined tail after departure to support incident forensics and legal-hold obligations. Telemetry is aggregated and purged of identifiers on a rolling basis. Support correspondence is retained for the shorter of two years or resolution plus one year. Records required by tax and corporate law are retained for the statutory period in the applicable jurisdiction.",
      },
      {
        id: "security",
        kind: "text-block",
        eyebrow: "10 · Security overview",
        h2: "The technical safeguards behind the promise.",
        body: "Nebbos enforces client isolation at the database layer through row-level security policies attached to every table; an application-layer bug that omits a client filter fails closed. Every request carries a signed identity claim verified before any read against your data. Every consequential action requires a named human approval attested through Layer 11 and logged to Layer 15 — the audit trail is append-only, hash-chained, and portable to the customer. Privileged actions require hardware-attested presence per the tier gate documented at /security. Encryption in transit uses TLS 1.3; encryption at rest uses AES-256 under keys managed in a hardware security module. See /security for the depth pass on controls.",
      },
      {
        id: "no-training",
        kind: "text-block",
        eyebrow: "11 · No shared-model training on your data",
        h2: "The training-data policy in plain terms.",
        body: "Customer content is not used to train models made available to other customers. Customer content is not used to train Nebbos&rsquo;s own general-purpose models. The default configuration disables any training use of customer content. Where a customer elects to fine-tune a private Pearl on their own corpus, that Pearl and its weights are held on the customer&rsquo;s client and exported to the customer on offboarding; they are not shared with any other customer. The only exception is a written opt-in agreement scoped to a specific corpus, a specific model, and a specific purpose — never an all-purposes default. This policy is a structural property of the substrate, disclosed under EU AI Act Article 11 technical-documentation obligations and referenced in the DPA at /legal/dpa.",
      },
      {
        id: "contact",
        kind: "inbox-router",
        eyebrow: "12 · How to reach the controller",
        h2: "Contact routes for privacy questions.",
        deck: "Data-subject-access requests, GDPR/CCPA questions, and Data Protection Officer contact go to privacy@nebbos.ai. Nebbos acknowledges within one business day.",
      },
      {
        id: "law",
        kind: "text-block",
        eyebrow: "13 · Governing law",
        h2: "Which law governs which controller.",
        body: "For customers contracted with Nebbos D.O.O., the controller of record is subject to the General Data Protection Regulation (Regulation (EU) 2016/679) and to the Serbian Law on Personal Data Protection (Zakon o zaštiti podataka o ličnosti). The competent supervisory authority is the Serbian Commissioner for Information of Public Importance and Personal Data Protection; EEA/UK data subjects retain the right to lodge a complaint with their local supervisory authority. For customers contracted with Nebbos AI, the controller of record is subject to the California Consumer Privacy Act (as amended by CPRA), the Colorado Privacy Act, the Virginia Consumer Data Protection Act, and analogous state privacy regimes as they enter force. Enforcement authority sits with the California Privacy Protection Agency and analogous state attorneys general. Choice of law and forum for disputes is governed by the MSA between customer and controller.",
      },
    ],
  },
  "legal/terms": {
    ...
    metaDescription: "The commercial terms under which Nebbos is provided to enterprise customers.",
    sections: [
      {
        id: "hero",
        kind: "hero-paper",
        eyebrow: "00 · Draft — pending counsel review",
        h1: "Terms of Service",
        deck: "The commercial terms under which Nebbos is provided to enterprise customers. Full MSA and DPA available on request via enterprise@nebbos.ai. The version published here is the read-you-can-share form of the same substrate that the MSA cites as authoritative.",
      },
      {
        id: "status",
        kind: "text-block",
        eyebrow: "01 · Draft status",
        h2: "This document is a draft pending counsel review.",
        body: "Nebbos publishes these Terms of Service under the 24-hour manual counsel-SLA path ratified in the request-lifecycle convention. The substance and structure reflect Nebbos&rsquo;s current commercial posture and are ready to serve buyer review, procurement due-diligence, and legal-desk pre-scoping. Formal counsel sign-off is pending and will render the equivalent contract-binding version, filed to the same URL. Material changes between this draft and the counsel-signed version will be summarized in a change-log at the foot of the page and, for active customers, notified through the notification channel configured in the MSA.",
      },
      {
        id: "acceptance",
        kind: "text-block",
        eyebrow: "02 · Acceptance",
        h2: "How these terms take effect.",
        body: "These terms take effect when a customer signs a Master Services Agreement with Nebbos AI or Nebbos D.O.O., when a customer executes an order form that references these terms, or when a customer accesses the Nebbos platform under a paid or trial subscription. Where the MSA conflicts with anything below, the MSA prevails. Where an executed order form conflicts with anything below, the order form prevails for the scope of that order. These terms do not apply to open-source components shipped separately under their own licenses.",
      },
      {
        id: "definitions",
        kind: "list-plain",
        eyebrow: "03 · Definitions",
        h2: "Terms used throughout this document.",
        items: [
          { title: "&lsquo;Nebbos&rsquo; means the contracting Nebbos entity — Nebbos AI, a business unit of Nebbos Technologies Corp in Los Angeles, California, or Nebbos D.O.O. in Beograd, Serbia — as named on the customer&rsquo;s MSA." },
          { title: "&lsquo;Customer&rsquo; means the legal entity that has executed an MSA or order form with Nebbos." },
          { title: "&lsquo;Platform&rsquo; means the Nebbos operator platform, its tools, its MCP surface, its Pearls, and the hardware-attested substrate that gates privileged actions." },
          { title: "&lsquo;Customer Content&rsquo; means data the Customer or its operators submit to, load into, or generate through the Platform, including Pearl-generated artifacts, memory, and audit records." },
          { title: "&lsquo;Documentation&rsquo; means the technical, security, and compliance documentation published at nebbos.ai and updated on the cadence stated in the MSA." },
          { title: "&lsquo;Order Form&rsquo; means the ordering document naming the products, tiers, quantities, term, and price the Customer has bought." },
          { title: "&lsquo;Service Levels&rsquo; means the availability, latency, and support commitments in the MSA service-level exhibit." },
        ],
      },
      {
        id: "service",
        kind: "text-block",
        eyebrow: "04 · The service",
        h2: "What the Platform provides.",
        body: "The Platform provides the Customer&rsquo;s operators with tools, Pearls, workflows, memory operations, and an attested audit trail, delivered through a web interface, a native desktop application where applicable, a mobile application where applicable, and a Model Context Protocol surface. The Platform is available under the tiers documented at /pricing. Nebbos may improve the Platform, add features, and deprecate features on the notice cadence stated in the MSA; material adverse changes carry a documented deprecation window and, where relevant, a migration path.",
      },
      {
        id: "obligations",
        kind: "text-block",
        eyebrow: "05 · Customer obligations",
        h2: "What the Customer commits to.",
        body: "The Customer is responsible for the actions its authorized operators take through the Platform, for keeping credentials secure, for enrolling and revoking users through the identity flows Nebbos publishes, for configuring approval routes appropriate to the risk of its operations, and for compliance with laws applicable to the content it processes. The Customer represents that it has the rights necessary to submit Customer Content to the Platform and that its use of the Platform will not infringe intellectual-property or privacy rights of any third party.",
      },
      {
        id: "use",
        kind: "list-numbered",
        eyebrow: "06 · Acceptable use",
        h2: "Uses the Platform does not permit.",
        items: [
          { title: "No unlawful, infringing, or deceptive use", body: "The Platform may not be used to create, host, or distribute content that is illegal in a relevant jurisdiction, that infringes intellectual-property rights, or that materially deceives a person about the origin of the content." },
          { title: "No security-defeating conduct", body: "No probing, scanning, or penetration testing of Nebbos infrastructure outside the responsible-disclosure process at /legal/responsible-disclosure. No attempt to bypass tier gates, forge attestation records, or circumvent the substrate&rsquo;s client isolation." },
          { title: "No use in prohibited AI-Act categories", body: "The Platform may not be used to build systems that fall within the prohibited-practices list in EU AI Act Article 5 — social scoring by public authorities, real-time remote biometric identification in public spaces outside law-enforcement exceptions, subliminal manipulation, exploitation of vulnerabilities, or untargeted scraping of facial images." },
          { title: "No cross-client data extraction", body: "Customer will not attempt to enumerate other Customers, their data, their sub-processor relationships, or their configurations through the Platform." },
          { title: "No high-risk deployment without written scope", body: "Where a Customer intends to use the Platform in a workflow the Customer classifies as high-risk under EU AI Act Annex III, the intended use is disclosed on the order form and Nebbos&rsquo;s technical-documentation obligations are scoped accordingly." },
        ],
      },
      {
        id: "ip",
        ...
        h2: "Who owns what.",
        body: "Nebbos owns the Platform, the substrate, the Documentation, all improvements Nebbos makes to any of them, and any generic feedback the Customer voluntarily provides. The Customer owns Customer Content and every artifact its operators produce through the Platform, including tuned Pearl weights, memory, preference pairs, and audit records. Nebbos&rsquo;s license to Customer Content is scoped strictly to operating the Platform on the Customer&rsquo;s behalf under the DPA at /legal/dpa. Nebbos does not aggregate Customer Content across customers, does not train shared models on Customer Content, and does not sell insights derived from Customer Content.",
      },
      {
        id: "pricing",
        kind: "text-block",
        eyebrow: "08 · Pricing and billing",
        h2: "How pricing and billing work.",
        body: "Prices, tiers, and quantities are stated on the executed order form. Enterprise pricing is per-quote and is not published; see /pricing for the tier taxonomy and enterprise@nebbos.ai for a quote. Invoices are due within the payment terms stated on the order form, defaulting to net-30 from invoice date. Overdue balances accrue interest at the lesser of one and a half percent per month or the maximum permitted by law. Tax is Customer&rsquo;s responsibility except where Nebbos is the statutory withholding party. Nebbos may suspend service for accounts more than 60 days past due after 15 calendar days&rsquo; written notice.",
      },
      {
        id: "confidentiality",
        kind: "text-block",
        eyebrow: "09 · Confidentiality",
        h2: "Both sides carry confidentiality obligations.",
        body: "Each party will hold the other&rsquo;s Confidential Information — non-public technical, commercial, security, or personnel information disclosed under this relationship — in confidence, use it only to perform under this contract, and protect it with the standard of care it uses for its own Confidential Information of comparable sensitivity. Standard exceptions apply for information that is public without breach, independently developed, received without duty, or required to be disclosed under legal process (with prior notice where lawfully allowed). Obligations survive termination for five years, except trade secrets and Customer Content, which are held for as long as they retain their character.",
      },
      {
        id: "warranties",
        kind: "text-block",
        eyebrow: "10 · Warranties and disclaimers",
        h2: "The warranties Nebbos gives, and the ones it does not.",
        body: "Nebbos warrants that it will perform the service materially in accordance with the Documentation, that it holds the rights to grant the licenses in these terms, and that the service will meet the Service Levels stated in the MSA. Nebbos disclaims all other warranties, express or implied, including merchantability, fitness for a particular purpose, and non-infringement, except to the extent those disclaimers are unenforceable under applicable law. Customer&rsquo;s exclusive remedies for a service-level breach are the credits stated in the MSA service-level exhibit and the termination rights in the termination clause. Nebbos does not warrant that the outputs of a Pearl are free from error — every consequential action carries a named human approval precisely because model outputs are subject to review before they take effect.",
      },
      {
        id: "liability",
        kind: "text-block",
        eyebrow: "11 · Limitation of liability",
        h2: "The liability cap and the carve-outs.",
        body: "Except for the carve-outs below, each party&rsquo;s aggregate liability arising out of or relating to this contract will not exceed the fees paid or payable by Customer in the twelve months preceding the event giving rise to the claim. Neither party will be liable for indirect, incidental, special, consequential, or punitive damages, or for lost profits, lost revenues, or lost data (except as directly measurable under the SLA credit regime). Carve-outs from the cap: liability for a party&rsquo;s indemnification obligations, breach of confidentiality, infringement of the other party&rsquo;s intellectual-property rights, willful misconduct or gross negligence, and Customer&rsquo;s obligation to pay fees due. Nothing in this clause limits liability that cannot be limited under applicable law.",
      },
      {
        id: "indemnity",
        kind: "text-block",
        eyebrow: "12 · Indemnification",
        h2: "The mutual indemnity structure.",
        body: "Nebbos will defend Customer against a claim by a third party that Customer&rsquo;s permitted use of the Platform under this contract infringes that third party&rsquo;s intellectual-property rights, and Nebbos will pay damages awarded by a court or agreed in settlement, provided Customer notifies Nebbos promptly, gives Nebbos sole control of defense and settlement, and cooperates reasonably. Nebbos&rsquo;s options if a claim arises are: procure the right to continue use, modify the Platform to become non-infringing, or terminate the affected service with a pro-rata refund. Customer will defend Nebbos against a claim by a third party arising from Customer Content, the Customer&rsquo;s use of the Platform outside the permitted scope, or the Customer&rsquo;s breach of the acceptable-use clause, on the same procedural terms.",
      },
      {
        id: "notices",
        kind: "list-numbered",
        eyebrow: "13 · Availability and operations notices",
        h2: "Two MSA clauses surfaced here for readability.",
        items: [
          { title: "§8.6 · Client-workspace unavailability notification", body: "When the Platform enters a state that materially prevents the Customer&rsquo;s client workspace from performing writes or step-up-protected operations, Nebbos will notify the Customer&rsquo;s designated ops contact via the notification channel configured in the MSA within thirty minutes of Nebbos&rsquo;s incident-response team acknowledging the state, and will publish a running status update to /status. Notification carries the affected surfaces, the degraded-capability class, and the current recovery ETA, updated on the incident-response cadence." },
          { title: "§8.7 · Weekly operations review", body: "Nebbos runs a weekly operations review that walks every ratified incident, every open substrate degradation, and every open ADR-scope commitment against Service Level obligations. A Customer whose contract includes the Enterprise tier receives the sanitized digest of the review at the cadence stated in the MSA notification exhibit, with the option to escalate any item into a joint working session." },
        ],
      },
      {
        id: "term",
        kind: "text-block",
        eyebrow: "14 · Term, termination, and survival",
        h2: "How the contract ends, and what survives.",
        body: "The contract runs for the term stated on the order form and renews per the order form. Either party may terminate for a material uncured breach after 30 calendar days&rsquo; written notice detailing the breach. Nebbos may suspend service immediately for a Customer&rsquo;s breach of the acceptable-use clause where the breach creates a security, legal, or reputational risk that a suspension notice would materially aggravate. On termination, the Customer receives the export routine documented in the DPA at /legal/dpa. Provisions that by their nature survive termination — payment, confidentiality, intellectual-property, disclaimer, limitation of liability, indemnity, dispute resolution, governing law — survive.",
      },
      {
        id: "dispute",
        kind: "text-block",
        eyebrow: "15 · Dispute resolution",
        h2: "The escalation ladder before litigation.",
        body: "A dispute arising under this contract is first escalated to executive representatives of each party for good-faith resolution within 30 calendar days of notice of the dispute. Failing resolution, the dispute is submitted to binding arbitration under the ICC Rules of Arbitration where the Customer contracts with Nebbos D.O.O., seated in Belgrade and conducted in English, or under the JAMS Comprehensive Arbitration Rules where the Customer contracts with Nebbos AI, seated in Los Angeles and conducted in English. Each party bears its own costs; the arbitrator apportions filing fees. Neither party will bring a class action, class arbitration, or representative action arising under this contract. Nothing in this clause prevents either party from seeking injunctive relief in a court of competent jurisdiction to protect intellectual-property or confidentiality rights.",
      },
      {
        id: "law",
        kind: "text-block",
        eyebrow: "16 · Governing law",
        h2: "Which law governs which contract.",
        body: "Contracts with Nebbos D.O.O. are governed by the law of the Republic of Serbia, without regard to conflict-of-laws principles, and by any Republic of Serbia consumer or data-protection statute that applies notwithstanding choice of law. Contracts with Nebbos AI are governed by the law of the State of California, without regard to conflict-of-laws principles, and by any California consumer or data-protection statute that applies notwithstanding choice of law. The United Nations Convention on Contracts for the International Sale of Goods does not apply to this contract.",
      },
      {
        id: "contact",
        kind: "inbox-router",
        eyebrow: "17 · Contact",
        h2: "How to reach the contracting party.",
        deck: "Contract questions, MSA/DPA requests, and enterprise procurement route to enterprise@nebbos.ai. Policy and legal questions route to legal@nebbos.ai.",
      },
    ],
  },
  "legal/dpa": {
    ...
    metaDescription: "GDPR-compliant Data Processing Addendum governing how Nebbos processes customer personal data. Dual-entity structure for US and EU customers. Machine-readable sub-processor pointer: subprocessors.json.",
    sections: [
      {
        id: "hero",
        kind: "hero-paper",
        ...
        deck: "The DPA that governs how Nebbos processes customer personal data on the Customer&rsquo;s behalf. Signed version available on request via legal@nebbos.ai. Machine-readable sub-processor manifest at /subprocessors.json (endpoint ships Sprint 3 Wave 5; the pointer establishes the contract now).",
      },
      {
        id: "status",
        kind: "text-block",
        eyebrow: "01 · Draft status",
        h2: "This document is a draft pending counsel review.",
        body: "Nebbos publishes this Data Processing Addendum under the 24-hour manual counsel-SLA path ratified in the request-lifecycle convention. The substance and structure reflect Nebbos&rsquo;s current processor posture and are ready to serve buyer review, DPIA support, and pre-negotiation scoping. Formal counsel sign-off is pending and will render the equivalent contract-binding version, filed to the same URL. Material changes between this draft and the counsel-signed version will be summarized in a change-log at the foot of the page and, for active customers with an executed MSA that references this DPA, notified through the notification channel configured in the MSA.",
      },
      {
        id: "parties",
        kind: "text-block",
        eyebrow: "02 · Parties",
        h2: "Who signs this DPA and on what side.",
        body: "The Customer named on the MSA is the data controller and the &lsquo;Data Exporter&rsquo; where relevant. Where the Customer&rsquo;s contracting entity sits in the United States, Canada, the United Kingdom, or any jurisdiction outside the EEA, the UK, or Switzerland, Nebbos AI — a business unit of Nebbos Technologies Corp registered in Wilmington, Delaware and operating from Los Angeles, California — acts as the data processor. Where the Customer&rsquo;s contracting entity sits in the EEA, the UK, or Switzerland, Nebbos D.O.O., registered in Beograd, Serbia, acts as the data processor. Nebbos operates under identical technical safeguards regardless of which entity is on the DPA; the distinction determines which supervisory authority, which cross-border transfer instrument, and which jurisdictional carve-outs govern the relationship.",
      },
      {
        id: "subject",
        kind: "text-block",
        eyebrow: "03 · Subject-matter and duration",
        h2: "The scope this DPA covers.",
        body: "This DPA covers the processing of Personal Data that Nebbos performs on the Customer&rsquo;s behalf to deliver the Platform under the MSA. The subject-matter is the operation of the Platform — running Pearls on the Customer&rsquo;s content, storing that content on the Customer&rsquo;s client, producing the audit trail, authenticating operators, honoring approval routes, and delivering the export routine. This DPA runs from the effective date of the MSA and continues until Nebbos has returned or deleted all Personal Data pursuant to the return-and-deletion clause below.",
      },
      {
        id: "nature",
        kind: "text-block",
        eyebrow: "04 · Nature and purpose of processing",
        h2: "The processing operations Nebbos performs.",
        body: "Nebbos processes Personal Data by collecting it (as loaded or created by Customer&rsquo;s operators), storing it (under the Customer&rsquo;s client with row-level isolation), retrieving it (through Pearl reads with attested identity), organizing it (through Pearl-generated proposals and memory operations), disclosing it (only to sub-processors listed at /legal/subprocessors), and erasing it (on Customer instruction and per the retention policy the Customer configures). Nebbos does not perform processing operations beyond those necessary to deliver the Platform under the MSA and this DPA. Nebbos does not use Personal Data for its own purposes.",
      },
      {
        id: "categories",
        kind: "list-plain",
        eyebrow: "05 · Categories of Personal Data",
        h2: "The categories of Personal Data Nebbos may process.",
        items: [
          { title: "Contact identifiers — name, email, phone, role, employer" },
          { title: "Authentication identifiers — SSO subject, credential attestation records, hardware-attested presence records" },
          { title: "Employment records where the Customer&rsquo;s use case ingests them — role, department, manager relationship, employment status" },
          { title: "Business communications the Customer loads into the Platform — correspondence, memos, meeting notes" },
          { title: "Operational records — approvals, actions taken, timestamps, and context available at approval" },
          { title: "Any special categories of data the Customer&rsquo;s use case ingests, disclosed in advance on the order form so Nebbos&rsquo;s technical-documentation and Article 9 lawful-basis obligations are scoped accordingly" },
        ],
      },
      {
        id: "subjects",
        kind: "list-plain",
        eyebrow: "06 · Categories of Data Subjects",
        h2: "The categories of Data Subject whose data may be processed.",
        items: [
          { title: "Customer&rsquo;s employees, contractors, and named operators of the Platform" },
          { title: "Customer&rsquo;s counterparties — suppliers, clients, prospects — whose contact details appear in Customer Content" },
          { title: "Individuals identified within Customer Content in the course of the Customer&rsquo;s operations" },
          { title: "Individuals whose consent-scope permissions the Customer chooses to load into the substrate for downstream Pearl decisions" },
        ],
      },
      {
        id: "obligations",
        kind: "list-numbered",
        eyebrow: "07 · Obligations of the Processor",
        h2: "The obligations Nebbos accepts under Article 28.",
        items: [
          { title: "Processing only on documented instructions", body: "Nebbos processes Personal Data only on documented instructions from the Customer, which are established through the MSA, this DPA, the order form, and any additional written instructions the Customer provides through the notification channel in the MSA. Nebbos notifies the Customer without undue delay if an instruction infringes applicable data-protection law." },
          { title: "Confidentiality of personnel", body: "Every person authorized to process Personal Data under this DPA is bound by written confidentiality obligations and receives data-protection training on a defined cadence." },
          { title: "Security under Article 32", body: "Nebbos maintains technical and organizational measures aligned with GDPR Article 32 — row-level client isolation enforced at the database, encrypted transit (TLS 1.3), encrypted rest (AES-256 under HSM-managed keys), hardware-attested credential gating for privileged actions, append-only hash-chained audit trail, defined incident-response procedure, documented business-continuity plan, background-checked personnel, and least-privilege access controls. See /security for the depth pass." },
          { title: "Sub-processor engagement", body: "Nebbos engages sub-processors only under this DPA&rsquo;s sub-processor clause below and imposes back-to-back data-protection obligations on each sub-processor." },
          { title: "Assistance with Data Subject rights", body: "Nebbos provides reasonable assistance to the Customer in fulfilling requests from Data Subjects exercising rights under GDPR Chapter III, given the nature of the processing." },
          { title: "Assistance with security, DPIA, and prior consultation", body: "Nebbos provides reasonable assistance to the Customer with Articles 32 (security), 33 (breach notification to authority), 34 (breach notification to Data Subject), 35 (DPIA), and 36 (prior consultation), taking into account the nature of processing and the information available to Nebbos." },
          { title: "Return or deletion at end of processing", body: "On Customer&rsquo;s election, Nebbos returns or deletes Personal Data at the end of the provision of services and deletes existing copies unless legal storage obligations apply." },
          { title: "Audits and inspections", body: "Nebbos makes available the information necessary to demonstrate compliance with Article 28 and permits reasonable audits per the audit clause below." },
        ],
      },
      {
        id: "subs",
        kind: "text-block",
        eyebrow: "08 · Sub-processors and change notification",
        h2: "How Nebbos onboards, notifies, and swaps sub-processors.",
        body: "The current list of sub-processors is at /legal/subprocessors and is machine-readable through /subprocessors.json (the endpoint ships Sprint 3 Wave 5; the pointer establishes the contract now). Nebbos serves 30 calendar days&rsquo; advance notice of new sub-processors or of a change to an existing sub-processor&rsquo;s role, through the notification channel configured in the MSA. Customer may object to a proposed sub-processor within the notice window on reasonable data-protection grounds. If objection is unresolvable, Customer may terminate the affected service without penalty and receive a pro-rata refund of prepaid fees.",
      },
      {
        id: "transfers",
        kind: "text-block",
        eyebrow: "09 · International transfers",
        h2: "The transfer instrument Nebbos relies on.",
        body: "Where processing under this DPA involves a transfer of Personal Data outside the EEA, the UK, or Switzerland, Nebbos relies on the European Commission&rsquo;s 2021 Standard Contractual Clauses (Commission Implementing Decision (EU) 2021/914) in the module appropriate to the transfer — typically Module Two (controller to processor) where the Customer is the exporter and Nebbos is the importer, and Module Three (processor to processor) where a sub-processor is downstream. The SCCs are incorporated by reference into this DPA; the annexes (Annex I — parties, description of transfer, competent supervisory authority; Annex II — technical and organizational measures; Annex III — sub-processor list) are populated per the annexes clause below. A UK International Data Transfer Addendum applies where a UK transfer is in scope. Where transfer is to a Nebbos AI sub-processor in the United States, the EU-US Data Privacy Framework applies where the recipient is certified.",
      },
      {
        id: "rights",
        kind: "text-block",
        eyebrow: "10 · Data Subject rights assistance",
        h2: "How Nebbos supports the Customer&rsquo;s Data Subject requests.",
        body: "Where a Data Subject exercises rights under GDPR Chapter III — access, rectification, erasure, restriction, portability, objection — against Customer as the controller, Nebbos supports the Customer by providing the technical means to locate, extract, correct, or delete the Data Subject&rsquo;s Personal Data within the Customer&rsquo;s client. Where the Data Subject routes the request to Nebbos directly, Nebbos acknowledges the request, does not respond substantively without Customer instruction, and forwards the request to the Customer&rsquo;s designated privacy contact within one business day. Nebbos performs its assistance within the statutory windows the Customer must meet.",
      },
      {
        id: "breach",
        kind: "text-block",
        eyebrow: "11 · Personal Data breach notification",
        h2: "How and when Nebbos notifies the Customer of a breach.",
        body: "Where Nebbos becomes aware of a Personal Data Breach as defined in GDPR Article 4(12) affecting Personal Data processed under this DPA, Nebbos notifies the Customer without undue delay and no later than 72 hours after Nebbos&rsquo;s incident-response team confirms the breach. Notification includes the nature of the breach, the categories and approximate number of Data Subjects affected, the categories and approximate number of records affected, the likely consequences, the measures Nebbos has taken or proposes to take to address the breach, and the point of contact for further information. Notification runs through the incident-notification channel configured in the MSA; where the MSA does not specify, notification is by email to the Customer&rsquo;s designated privacy contact and by concurrent post to the Customer&rsquo;s registered address.",
      },
      {
        id: "return",
        kind: "text-block",
        eyebrow: "12 · Return and deletion",
        h2: "What happens to Customer data at end of term.",
        body: "On end of term, or on Customer&rsquo;s election at any earlier point, Nebbos returns the Personal Data to the Customer through the export routine documented in the MSA offboarding exhibit — machine-readable format (JSONL plus independent verifier), Customer content plus tuned Pearl weights plus audit trail plus verifier tooling, on a timeline the Customer controls. After the Customer confirms receipt, Nebbos executes a documented deletion routine and provides a certificate of destruction. Nebbos retains Personal Data beyond that only where a specific statutory obligation requires retention, and only to the extent required.",
      },
      {
        id: "audit",
        kind: "text-block",
        eyebrow: "13 · Audits",
        h2: "How Nebbos supports the Customer&rsquo;s audit rights.",
        body: "Nebbos supports the Customer&rsquo;s audit rights under GDPR Article 28(3)(h) through the following mechanisms. First, Nebbos makes available its SOC 2 Type II report (once issued), its ISO 27001 certification (once issued), its EU AI Act Article 11 technical documentation, and any third-party attestation of controls, under NDA on request. Second, Nebbos responds to Customer&rsquo;s reasonable written questions about specific controls within 15 business days. Third, Customer may conduct a scoped on-site or virtual audit at reasonable frequency, at Customer&rsquo;s cost, on 60 calendar days&rsquo; written notice, subject to scope agreed with Nebbos and to confidentiality obligations covering everything the audit exposes. Sub-processor audits route through Nebbos&rsquo;s existing sub-processor-audit agreements.",
      },
      {
        id: "liability",
        kind: "text-block",
        eyebrow: "14 · Liability, term, termination",
        h2: "How liability and duration are handled under this DPA.",
        body: "Each party&rsquo;s liability arising out of or relating to this DPA is subject to the limitation-of-liability provisions in the MSA. Nothing in this DPA excludes liability that cannot be excluded under applicable data-protection law, including GDPR Article 82. This DPA takes effect with the MSA, runs coterminous with the MSA, and continues thereafter only for the time necessary to complete return-and-deletion. Either party may terminate this DPA on written notice if the other party materially breaches a data-protection obligation and fails to cure within 30 calendar days.",
      },
      {
        id: "annexes",
        kind: "text-block",
        eyebrow: "15 · Standard Contractual Clauses annexes",
        h2: "Where the SCC annexes live.",
        body: "The SCC annexes (Annex I — parties, description of transfer, competent supervisory authority; Annex II — technical and organizational measures; Annex III — sub-processor list) are populated per the Customer&rsquo;s order form and the sub-processor list at /legal/subprocessors. On execution of the MSA and this DPA, Nebbos delivers the completed annexes as an executable exhibit for the Customer to countersign. The technical-and-organizational-measures annex incorporates the security overview at /security by reference. Where the UK IDTA applies, the equivalent UK annex tables are populated in parallel.",
      },
      {
        id: "contact",
        kind: "inbox-router",
        eyebrow: "16 · Contact",
        h2: "How to reach the DPA counterparty.",
        deck: "DPA signature, sub-processor questions, and Data Protection Officer contact route to privacy@nebbos.ai and legal@nebbos.ai. Breach coordination and audit scheduling escalate through the incident-notification channel configured in the MSA.",
      },
    ],
  },
  "legal/subprocessors": {
