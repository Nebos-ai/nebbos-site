...
export const PAGES = {
  ...
  home: {
    ...
    sections: [
      ...
      },
      {
        ...
        ctaSecondary: { label: "See the products", href: "/products", variant: "ghost-light" },
        imageV2: 3,
      },
    ],
  },
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { title: "How does data privacy work?", body: "Row-level client isolation (Layer 01) means employee data never leaves your client. Retention policies are configurable per your employment-law jurisdiction." },
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { title: "Data residency + segregation?", body: "Row-level client isolation (Layer 01). Configurable data residency (US / EU / APAC)." },
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { title: "Data residency for cross-border manufacturing?", body: "Configurable per client." },
  ...
  "solutions/public-sector": {
    ...
    sections: [
      ...
      },
      {
        ...
        h2: "What leaders ask first.",
        items: [
          { title: "Is this FedRAMP / StateRAMP compatible?", body: "Row-level client isolation + configurable data residency. FedRAMP path for federal deployments — contact enterprise@nebbos.ai." },
  ...
  trust: {
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          { title: "Every human approval attested and time-stamped", body: "Every consequential action is approved by a named human. The approval carries their identity, the timestamp, the context they saw, and the specific action they authorized. The record is signed the moment it&rsquo;s written &mdash; verified end-to-end by your auditor&rsquo;s own tool." },
          { title: "Every Pearl action logged to an append-only audit trail", body: "Every action a Pearl performs &mdash; every read, every proposal, every write &mdash; is written into an append-only chain. Each record depends cryptographically on the one before it. Your inspector-general walks the chain end-to-end and sees whether anything was inserted, altered, or removed." },
          { title: "Every request carries identity through client isolation", body: "Client isolation is enforced by the database itself, not by the application on top of it. Every query proves identity before it runs; a bug in application code can&rsquo;t leak data across clients because the database refuses to serve the read. Structural, not policy." },
          { title: "Every audit trail is portable to you if you leave", body: "Audit-trail export is a first-class capability, not a departure-day scramble. Request a full export any time in a machine-readable format with an independent verifier. Because the routine runs on every deploy, you know it works when you need it." },
        ],
      },
      {
        id: "ownership",
      ...
      },
      {
        ...
        items: [
          { title: "Client isolation at the database", body: "Enforced by the database itself, not by the application. A bug in application code can&rsquo;t leak data across clients &mdash; the database won&rsquo;t serve the read. Structural, not policy." },
          { title: "Hardware-attested identity on every request", body: "Every request carries an identity your CISO can trace. Service accounts, humans, and workloads each have distinct identity classes with distinct authorization scopes." },
          { title: "Named human on every consequential action", body: "Every write, every elevated call flows through an approval graph. Approval routes are configurable per domain, per action class, per risk tier." },
          { title: "Portability tested on every deploy", body: "Offboarding is a documented flow with fixed timelines. The export routine runs on every deploy so we already know it works when you need it." },
          { title: "Audit trail your inspector-general reads directly", body: "Append-only chain, hash-signed, verifiable end-to-end by your auditor&rsquo;s own tool. The record your regulator reads." },
        ],
      },
      {
        id: "negative-space",
        kind: "list-numbered",
        eyebrow: "07 · Six commitments the substrate keeps",
        h2: "Six commitments the substrate keeps.",
        items: [
          { title: "Your preference pairs train YOUR Pearl only", body: "Preference pairs from your operators tune the Pearl running for your client. They do not train a base model available to any other client." },
          { title: "Your metrics stay yours", body: "No cross-client aggregation for our own benchmarking or marketing. Your operational metrics leave your client only when you export them." },
          { title: "30 days advance notice on any subprocessor change", body: "The infrastructure vendors Nebbos itself runs on are disclosed at /legal/subprocessors. Enterprise customers get 30 days advance notice of any change. These vendors don&rsquo;t touch customer data &mdash; that lives on the customer&rsquo;s Cradle." },
          { title: "Every consequential action carries a named human approval", body: "Not a configuration flag &mdash; an architectural property. There is no version of the substrate where consequential actions run autonomously." },
          { title: "Offboarding is documented, timeline-fixed, and tested", body: "The export routine runs on every deploy so we know it works. No retention-friction pattern, no departure-day scramble." },
          { title: "Every Pearl action ships with the reasoning trace attached", body: "The human who approves sees why. The audit trail records what the Pearl considered and what it recommended before the human decision." },
        ],
      },
      {
        id: "comparison",
      ...
      },
      {
        ...
        items: [
          { title: "How does client isolation actually work?", body: "The isolation is enforced by the database itself, not by the application on top of it. Every request carries a client identity that the database checks against every row before it returns any data. Even a bug in application code can&rsquo;t leak data across clients &mdash; the database won&rsquo;t serve the read. Your engineers can review the enforcement themselves under NDA." },
          { title: "Can we run our own client on our own infrastructure?", body: "Yes — single-client deployment is available on the enterprise tier. Contact enterprise@nebbos.ai." },
          ...
          { title: "What about model-provider data-retention?", body: "Model-provider settings are configurable per client. Anthropic, OpenAI, Google, and self-hosted-model configurations each have distinct retention profiles. Default: zero-retention where the provider supports it." },
          { title: "How do you handle a subpoena or law-enforcement request?", body: "We route through counsel and notify the client unless legally prohibited. Detailed procedure at /legal/law-enforcement." },
        ],
      },
      {
        id: "certs",
        ...
        items: [
          ...
          { title: "ISO 27001:2022", body: "Annex A controls are implemented across identity, access, audit, encryption, and data retention. The ISMS is on the certification track. Full status at /compliance." },
          { title: "EU AI Act Article 11 · Annex IV", body: "Substrate that generates Annex IV evidence ships today &mdash; memory captures model artifacts, reasoning captures decision provenance, attestation captures the audit trail. The client-facing documentation pack lands ahead of the 2027-08-02 deadline. Full status at /compliance." },
          { title: "HIPAA — healthcare readiness", body: "Technical safeguards ship today &mdash; access control, audit trail, integrity, entity authentication, transmission security. Administrative + physical safeguards + BAA template ready ahead of first healthcare deployment. Full status at /compliance." },
          { title: "FERPA — K-12 and higher-ed readiness", body: "Substrate controls mapped to FERPA educational-records handling. School Official controls, retention configuration, and documentation ready ahead of first district deployment scoped to student PII. Full status at /compliance." },
  ...
  security: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: "Every action classified as consequential passes through a three-factor tier gate composed of biometric authentication, physical Cradle presence, and enclave-signed approval — combining into three tiers of authority. L1 Guest gates on biometric only (Touch ID / Face ID / Windows Hello / Android BiometricPrompt), covering dashboard reads and low-risk tool calls. L2 Host adds a Nebbos-issued Cradle in the port, covering client-scope writes, memory registers, and knowledge-graph mutations. L3 Architect adds an enclave-signed approval token derived from a WebAuthn ceremony, covering client create/destroy, substrate mutation, and cross-client operations. The Cradle substrate is a FIPS 140-3 Level 3 validated cryptographic module — the certificate covers the module boundary; the whole product is not FIPS-scoped. IP68 waterproof, MIL-STD-810G shock-tested, TAA-compliant supply chain, tamper-evident epoxy seal. The MCP binary and per-client key material ship on the encrypted volume; unplug the Cradle, and elevated capability is cryptographically absent — not policy-disabled. Two-person authorization is enforced in hardware at L3 through Architect-Cradle plus Developer-Cradle co-signature via WebAuthn with a 60-second time-to-live. Full hardware detail at /products/cradle.",
      },
      {
        id: "controls-map",
        kind: "list-numbered",
        ...
        items: [
          { title: "AC-3(2) · Dual Authorization", body: "The L3 two-person rule enforced in hardware via co-signature of Architect Cradle + Developer Cradle." },
      ...
      },
      {
        ...
        items: [
          { title: "Layer 01 · Data", body: "Row-level client isolation, encryption at rest, per-client DEK. The primary defense against cross-client leakage." },
          ...
          { title: "Layer 14 · Observability", body: "Real-time detection of anomalous access patterns, credential misuse, client-boundary anomalies." },
      ...
      },
      {
        ...
        items: [
          ...
          { title: "Client notification", body: "Severity 1 clients notified within 24 hours of confirmed impact; severity 2 within 72 hours." },
          { title: "Regulator notification", body: "Where regulatorily required (GDPR 72-hour, HIPAA 60-day, various state-privacy), we support client filing with a prepared evidence packet." },
          { title: "Post-incident review", body: "Written post-incident report shared with impacted clients within 30 days of resolution. Root cause + specific remediation." },
      ...
      },
      {
        ...
        items: [
          { title: "Do you support customer-managed encryption keys?", body: "Yes — BYOK on the enterprise tier. Interim tiers use per-client DEK managed by our KMS with documented rotation cadence and access logging." },
      ...
      },
      {
        ...
        items: [
          ...
          { title: "Model providers", body: "Anthropic, OpenAI, Google. Configured per client. Zero-retention default where supported." },
  ...
  compliance: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: "For US healthcare clients operating as Covered Entities or Business Associates, HIPAA-readiness is in progress. Substrate technical safeguards are implemented (access control, audit trail, integrity, entity authentication, transmission security) and map to the HIPAA Security Rule technical-safeguards section. Administrative safeguards, physical safeguards, and a Business Associate Agreement template are in preparation ahead of first healthcare deployment. Clients with HIPAA in vendor review can request the current implementation status and BAA availability date via legal@nebbos.ai.",
      },
      {
        id: "ferpa",
        kind: "text-block",
      ...
      },
      {
        ...
        items: [
          { title: "Layer 01 · Data", body: "Row-level isolation, encryption at rest, data-residency configurable per client." },
          ...
          { title: "Layer 07 · Memory", body: "Retention policies configurable per client, per data class. GDPR erasure, HIPAA retention, FERPA educational-records handling." },
      ...
      },
      {
        ...
        items: [
          { title: "Do you have a SOC 2 Type II report we can review?", body: "Not yet — SOC 2 Type II certification is in progress. Clients with SOC 2 as a vendor-review gate can request the current control-implementation status and the projected report date via legal@nebbos.ai." },
          { title: "What is your data-residency posture?", body: "US + EU regions available. Additional regions available on the enterprise tier. Data residency configurable at client provisioning; data does not leave the elected region without client authorization." },
          { title: "How do you handle GDPR data-subject rights requests?", body: "First-class client-admin flow. Client admin submits the request; Nebbos executes and returns evidence within the GDPR-mandated timeline." },
          { title: "What is your policy on training on customer data?", body: "We do not train shared models on client data. Preference pairs your client produces stay in your client and are exportable to you. This is the training-substrate side of Nebbos." },
          ...
          { title: "What happens on data-breach notification obligations?", body: "We support client filing with a prepared evidence packet within regulatory timelines (GDPR 72 hours, HIPAA 60 days, state-specific)." },
        ],
      },
      {
        id: "nda",
        ...
        body: "Reach legal@nebbos.ai with a brief description of your review scope (SOC 2, ISO 27001, EU AI Act Annex IV, HIPAA, FERPA, sector-specific). We respond within 2 business days with either the requested document, a current-status memo for controls still in progress, or a mutual NDA for signature. Standard mutual NDA available at /legal/mutual-nda. For procurement teams with an existing NDA already in place, we counter-sign to save a cycle.",
      },
      {
        id: "regulator",
        kind: "text-block",
      ...
      },
      {
        ...
        imageFamily: "concept-audit-attestation",
        ctaPrimary: { label: "legal@nebbos.ai", href: "mailto:legal@nebbos.ai", variant: "solid-light" },
    ...
    sections: [
      {
        ...
        deck: "How to deploy a Pearl. How to define an approval graph. How to wire your existing systems into the substrate. The reference documentation engineering teams need to operate Nebbos in production.",
      },
      {
        id: "surfaces",
        kind: "list-numbered",
      ...
      },
      {
        ...
        kind: "cta-band",
        h2: "Ready to build?",
        deck: "Engineering runs the technical intake and confirms fit before the deployment package ships. One email opens that conversation.",
        ctaPrimary: { label: "engineering@nebbos.ai", href: "mailto:engineering@nebbos.ai", variant: "primary" } as CTA,
        ctaSecondary: { label: "Book a demo", href: "/demo", variant: "ghost" } as CTA,
      },
    ],
  },
    ...
    sections: [
      {
        ...
        h1: "What&rsquo;s new.",
        deck: "Every release. Every migration. Every capability that shipped, with dates. Public entries for the shape of the change; specifics live in each deployment's own release notes.",
      },
      {
        id: "entries",
        kind: "list-numbered",
        ...
        items: [
          { title: "2026-09-13 &mdash; Substrate-baseline surface on nebbos.ai", body: "The Nebbos self-baseline (30-day rolling hook-fire count) now renders on the home page. Every deployment measured against the same 100% denominator. Numbers are live, refreshed daily from the substrate telemetry pipe." },
          { title: "2026-09-13 &mdash; Presentation route + run-layer voice update", body: "/presentation is now a real surface with the four-slide run-layer story and the downloadable PDF embedded inline. The four /platform pages that used to link to a dead route now open to the real thing." },
          { title: "2026-09-12 &mdash; Hook-telemetry substrate", body: "Nebbos measures its own substrate understanding via 30-day rolling hook fires across the run layer. This baseline is what every new deployment is scored against before production go-live. Tool contract, CLI report, and deployment onboarding gate all shipped together." },
          { title: "2026-06-27 &mdash; IA and content pass", body: "The marketing site's full information architecture — 46 routes spanning Platform, Solutions, Trust, Resources, Company, Legal — is live with real written content. MDX content collections seeded with first substantive entries." },
          { title: "2026-06-27 &mdash; Site rebuild on Next.js", body: "The Nebbos marketing site moves from static HTML to a Next.js App Router application with its own brand-forward design system, MDX content collections, and canonical information architecture." },
        ],
      },
      {
        id: "cadence",
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { title: "Nebbos Technologies (corporate)", body: "nebbostechnologies.com. Operational." },
        ],
      },
      {
        id: "incidents",
      ...
      },
      {
        id: "subscribe",
        kind: "inbox-router",
        eyebrow: "03 · Subscribe to status updates",
        h2: "Get every incident as it lands.",
        deck: "Operational teams running Nebbos in production subscribe to the status channel. One email routes the request; RSS and webhook subscriptions ship in the deployment package.",
      },
    ],
  },
  ...
  /* ═══════════════ LEGAL DOCS ═════════════════════════════════════ */
  /* ═════════════════════════════════════════════════════════════════════
   * /legal/privacy — Infrastructure Notice
   * Reframed 2026-09-18 under doctrine `feedback_nebbos_is_infrastructure_not_
   * data_processor_no_dpa_framing_2026_09_18` (supersedes CLOSED PR #109).
   * Nebbos is infrastructure the customer owns and runs. This page explains
   * that the platform does not touch customer data — narrow account-metadata
   * scope only. Draft-status posture on hero; counsel review pending.
   * ─────────────────────────────────────────────────────────────────────── */
  "legal/privacy": {
    slug: "/legal/privacy",
    title: "Infrastructure notice · Your data stays with you",
    metaDescription: "Nebbos is infrastructure. Your data lives on your Cradle, encrypted with keys derived from your biometric. Nebbos never accesses it. This notice covers the narrow account-metadata scope.",
    sections: [
      {
        id: "hero",
        kind: "hero-paper",
        eyebrow: "00 · Notice · Draft — pending counsel review",
        h1: "Your data stays with you.",
        deck: "Nebbos is infrastructure you own and run. The Cradle sits on your desk. Your memory lives on it, encrypted with a key derived from your biometric. Your operator&rsquo;s tool calls run through an MCP binary hosted on your machine. Nebbos sees opaque audit hashes and nothing else. This notice explains what that means for the narrow platform-account metadata Nebbos does touch.",
      },
      {
        id: "draft-status",
        kind: "text-block",
        eyebrow: "01 · Draft status",
        h2: "This notice is a draft pending counsel review.",
        body: "The plain-language content on this page reflects Nebbos&rsquo;s ratified product doctrine and legal-entity structure. Counsel has not yet completed formal review. For a counsel-signed instrument tied to a specific engagement — a Software License Agreement, Master Services Agreement, or narrow-scope account-metadata addendum — write to legal@nebbos.ai and Nebbos legal returns a countersigned draft within 24 hours during business hours. That instrument governs, not this page.",
      },
      {
        id: "short-version",
        kind: "text-block",
        eyebrow: "02 · How Nebbos handles data (the short version)",
        h2: "The Cradle carries your data. Nebbos does not.",
        body: "Every operator authorized above L1 carries a Nebbos-issued Cradle. Your memory — the accumulated context that makes the Pearl valuable — sits on the Cradle, encrypted at rest with AES-256-GCM and a key derived from the operator&rsquo;s biometric. Every tool call your operator makes runs through an MCP binary hosted on the same Cradle. Every approval event a human authorizes lands in an append-only, hash-chained audit trail written to storage your keys unlock. Nebbos sees the opaque audit hashes to prove chain integrity. Nebbos does not see the payloads, the memory contents, the tool-call arguments, or the approval reasoning. The keys never leave the Cradle.",
      },
      {
        id: "what-nebbos-touches",
        kind: "list-numbered",
        eyebrow: "03 · What Nebbos DOES touch",
        h2: "The narrow surface — platform-account metadata.",
        deck: "Running the nebbos.ai account plane requires a small amount of routine web-application data. This is the entire list.",
        items: [
          { title: "Account identity", body: "Work email, display name, organization name, chosen tenant slug. Used to authenticate you when you sign in, to route support correspondence, to render your name in the operator UI on your own Cradle." },
          { title: "Session cookies", body: "First-party session cookies set by the nebbos.ai account plane. Used to keep you signed in during a session and to remember non-sensitive preferences (theme, last-viewed page). No third-party tracking, no advertising cookies." },
          { title: "Product-plane telemetry", body: "Page views on nebbos.ai marketing surfaces (which pages loaded, referrer, viewport class). Aggregated at the visit level; not linked to your operator identity. Used to prioritize marketing-surface work." },
          { title: "Support correspondence", body: "The subject line and timestamp of email you send to any Nebbos inbox (hello, legal, security, engineering, enterprise, privacy). The body of the email is stored in the inbox provider&rsquo;s system, retention per §07 below." },
          { title: "Payment metadata", body: "When self-serve billing lands: billing name, billing address, card last-four, receipt records. Full card numbers never touch Nebbos infrastructure; the payment processor holds them." },
        ],
      },
      {
        id: "controller-processor-does-not-fit",
        kind: "text-block",
        eyebrow: "04 · Why the controller / processor framing does not fit",
        h2: "The traditional SaaS DPA model does not apply here.",
        body: "A Data Processing Agreement under GDPR Article 28 governs the vendor-customer relationship when the vendor processes personal data on behalf of the customer. That instrument assumes the vendor holds the customer&rsquo;s operational data on the vendor&rsquo;s infrastructure. Nebbos is a categorical mismatch to that assumption. The customer owns the Cradle. The customer runs the MCP binary. The customer&rsquo;s memory is encrypted with a key derived from the customer&rsquo;s biometric. The customer is both the data controller and the data processor for the operational data. Nebbos is the software vendor and the hardware manufacturer, not the data processor. The right legal instruments are a Software License Agreement, a Master Services Agreement, a Hardware Warranty, and Support Terms. The narrow account-metadata scope on this page is the only surface where a data-processing relationship exists, and it is covered inline below.",
      },
      {
        id: "what-we-provide",
        kind: "list-numbered",
        eyebrow: "05 · What we do provide",
        h2: "The instruments that actually govern the relationship.",
        items: [
          { title: "Software License Agreement", body: "Grants the operator the license to run the Nebbos MCP binary, the Pearl runtimes, and the Nebbos client software on the operator&rsquo;s own infrastructure. See /legal/terms." },
          { title: "Master Services Agreement", body: "Governs the commercial relationship — support model, uptime targets for the nebbos.ai account plane, operator obligations, payment terms. See /legal/terms." },
          { title: "Hardware Warranty", body: "Separate purchase agreement and warranty for the Nebbos Cradle. Ships with the device; also available on request via legal@nebbos.ai." },
          { title: "Support Terms", body: "Response SLAs, escalation paths, on-call rotations. Referenced in the MSA and detailed at /legal/terms." },
          { title: "Security attestations", body: "SOC 2 (in progress), ISO 27001:2022 (not yet held), EU AI Act Article 11 · Annex IV (in preparation), HIPAA readiness (in progress). Authoritative status at /compliance and /security." },
        ],
      },
      {
        id: "legal-team-requests",
        kind: "text-block",
        eyebrow: "06 · Legal-team requests",
        h2: "If your procurement checklist requires a data-processing instrument.",
        body: "Some enterprise procurement flows require a signed data-processing instrument regardless of vendor architecture. Where that applies to the narrow account-metadata scope described above, Nebbos legal countersigns a Narrow-Scope Account Metadata Addendum: a machine-account-only addendum that covers the account-plane touches (identity, session cookies, telemetry, support metadata, payment metadata) and nothing else. It does not attempt to characterize the Cradle-based substrate as a processor relationship, because it is not one. Request via legal@nebbos.ai; Nebbos legal returns a countersigned draft within 24 hours during business hours.",
      },
      {
        id: "account-metadata-specifics",
        kind: "list-numbered",
        eyebrow: "07 · Account-metadata specifics",
        h2: "For that narrow scope only — retention, deletion, breach, use.",
        deck: "Every commitment below applies to the account-metadata scope enumerated in §03 above. It does NOT apply to Cradle-resident data, memory, or tool-call payloads — Nebbos does not touch those.",
        items: [
          { title: "Retention", body: "Account identity retained for the life of the account plus 90 days after account closure to service in-flight support tickets. Session cookies retained for the session duration only. Product-plane telemetry retained 13 months at visit-level granularity, aggregated thereafter. Support correspondence retained 24 months. Payment metadata retained per tax-record obligations of the contracting entity (generally 7 years)." },
          { title: "Deletion on request", body: "Account identity and product-plane telemetry deleted within 30 days of a written request to privacy@nebbos.ai. Payment metadata retained only as required by tax law; deletion certificate issued for everything else." },
          { title: "Breach notification", body: "72-hour written notification to affected operators if account-metadata is exposed. The notification identifies the affected data class, the timeline, the remediation, and the contact for follow-up. Delivered by email to the account&rsquo;s work-email address plus a banner on nebbos.ai when signed in." },
          { title: "No marketing use", body: "Account identity and telemetry are never used for third-party marketing, advertising, or data brokerage. Nebbos does not sell your account metadata. Nebbos does not share it across contracting entities." },
          { title: "No training use", body: "Account metadata is never used to train any Nebbos or third-party model. Cradle-resident data is inaccessible to Nebbos and therefore also never used to train any model." },
        ],
      },
      {
        id: "subprocessors",
        kind: "list-numbered",
        eyebrow: "08 · Sub-processors for account metadata",
        h2: "The narrow vendor list — account plane only.",
        deck: "Because Nebbos never accesses Cradle-resident data, there is no full-SaaS-DPA-style sub-processor list. What appears below is the narrow set of infrastructure vendors the nebbos.ai account plane runs on.",
        items: [
          { title: "Authentication provider", body: "WorkOS — enterprise SSO, directory sync, session management on the nebbos.ai account plane. SOC 2 Type II, ISO 27001." },
          { title: "Web hosting + CDN", body: "Commercial hosting provider (US + EU regions) for the nebbos.ai marketing surfaces and account plane. SOC 2, ISO 27001." },
          { title: "Transactional email", body: "Delivery provider for account-lifecycle email (sign-in links, receipts, support responses, breach notifications). SOC 2." },
          { title: "Observability", body: "Metrics + tracing + log aggregation for the nebbos.ai account plane only. Cradle-side telemetry stays on the Cradle. SOC 2." },
          { title: "Payment processor", body: "When self-serve billing lands: card-processing vendor. PCI DSS Level 1. Full card numbers never touch Nebbos infrastructure." },
        ],
      },
      {
        id: "governing-entities",
        kind: "list-numbered",
        eyebrow: "09 · Governing entities",
        h2: "Which Nebbos entity holds your account metadata.",
        deck: "Which regional operating entity is the counterparty depends on where the contracting operator sits. The parent Delaware C-Corp does not directly hold operator account metadata.",
        items: [
          { title: "Nebbos.ai (US company)", body: "US-based operating entity. Counterparty for operators contracting from the United States. Holds US account metadata; US contract-law regime; California JAMS arbitration seat." },
          { title: "Nebbos D.O.O. (Balkan operations)", body: "Serbian operating entity. Counterparty for operators contracting from Balkan markets. Holds Balkan account metadata; Serbian contract-law regime; ICC Belgrade arbitration seat." },
          { title: "Greek company (EU main office)", body: "Greek operating entity, incorporation target November 2026. Counterparty for operators contracting from the European Union. Holds EU account metadata; unqualified GDPR territorial scope; EU-side controller for account plane." },
        ],
      },
      {
        id: "changes",
        kind: "text-block",
        eyebrow: "10 · Changes to this notice",
        h2: "How Nebbos notifies operators of a change.",
        body: "Material changes to the substance of this notice — a new sub-processor added to the account plane, a change to retention, a change to the governing-entity split — are notified to enterprise operators at least 30 days in advance by email to the account&rsquo;s work-email address plus a banner on nebbos.ai. Non-material changes (clarification, wording, cross-reference updates) are logged in the /changelog page. Every version of this notice is retained; earlier versions are available on request via legal@nebbos.ai.",
      },
      {
        id: "contact",
        kind: "text-block",
        eyebrow: "11 · Contact",
        h2: "How to reach Nebbos about this notice.",
        body: "Data-subject rights (access, correction, deletion, portability): privacy@nebbos.ai. Legal-team requests for a Narrow-Scope Account Metadata Addendum: legal@nebbos.ai. Security-relevant questions: security@nebbos.ai. Nebbos returns countersigned or substantive responses within 24 hours during business hours. Response SLAs are published at /security.",
      },
      {
        id: "related",
        kind: "list-plain",
        ...
        h2: "Deeper reading.",
        items: [
          { title: "Terms — Software license, MSA, Support terms, Hardware warranty" },
          { title: "Sovereignty — Data, model, and operational sovereignty by architecture" },
          { title: "Security — Technical controls in depth" },
  ...
  /* ═════════════════════════════════════════════════════════════════════
   * /legal/terms — Software License + MSA structure
   * Reframed 2026-09-18 under doctrine `feedback_nebbos_is_infrastructure_not_
   * data_processor_no_dpa_framing_2026_09_18`. This page is the terms-of-use
   * governing the operator&rsquo;s use of Nebbos software + services. Draft-status.
   * ─────────────────────────────────────────────────────────────────────── */
  "legal/terms": {
    slug: "/legal/terms",
    title: "Terms · Software license + Master services + Hardware warranty",
    metaDescription: "The instruments that govern the use of Nebbos. A Software License Agreement, a Master Services Agreement, a Hardware Warranty, and Support Terms. No DPA — Nebbos is infrastructure.",
    sections: [
      {
        id: "hero",
        kind: "hero-paper",
        eyebrow: "00 · Terms · Draft — pending counsel review",
        h1: "The instruments that govern using Nebbos.",
        deck: "A Software License Agreement for the Nebbos software. A Master Services Agreement for the commercial relationship. A Hardware Warranty for the Cradle. Support Terms for the operator-facing service. No Data Processing Agreement — Nebbos is infrastructure the customer owns and runs. This page is the plain-language summary of every instrument; the countersigned draft governs.",
      },
      {
        id: "draft-status",
        kind: "text-block",
        eyebrow: "01 · Draft status",
        h2: "This page is a draft pending counsel review.",
        body: "The clauses summarized on this page reflect Nebbos&rsquo;s ratified product doctrine and commercial posture. Counsel has not yet completed formal review. For the countersigned instruments themselves — SLA, MSA, Hardware Warranty, Support Terms — write to legal@nebbos.ai. Nebbos legal returns countersigned drafts within 24 hours during business hours. The countersigned instruments govern, not this page.",
      },
      {
        id: "what-covered",
        kind: "list-numbered",
        eyebrow: "02 · What these terms cover",
        h2: "Four instruments, one relationship.",
        deck: "Nebbos&rsquo;s commercial relationship with the operator organization is defined by four instruments, each governing a distinct surface of the substrate.",
        items: [
          { title: "Software License Agreement (SLA)", body: "Grants the license to run Nebbos software — the MCP binary, the Pearl runtimes, the client software — on the operator organization&rsquo;s infrastructure. Defines permitted uses, restrictions, termination triggers." },
          { title: "Master Services Agreement (MSA)", body: "Governs the commercial relationship — payment terms, support model, uptime targets for the nebbos.ai account plane, operator obligations, warranties, liabilities, dispute resolution." },
          { title: "Hardware Warranty + Purchase Agreement", body: "Separate instrument covering the Nebbos Cradle. Ships with the device. Covers defect remediation, replacement, revocation on operator departure." },
          { title: "Support Terms", body: "Response SLAs, escalation paths, on-call rotations, incident-notification obligations. Referenced by the MSA; detailed below in §14 (Notice clauses)." },
        ],
      },
      {
        id: "software-license",
        kind: "text-block",
        eyebrow: "03 · The Nebbos software license",
        h2: "Grant, restrictions, permitted uses, termination.",
        body: "GRANT — Nebbos grants the operator organization a non-exclusive, non-transferable, worldwide license to run the Nebbos software on the operator organization&rsquo;s infrastructure for the operator organization&rsquo;s internal business use, for the term of the MSA. RESTRICTIONS — the operator may not reverse-engineer, decompile, or disassemble the Nebbos software except to the extent expressly permitted by applicable law; may not resell, sublicense, rent, or lease the Nebbos software to any third party; may not remove or alter Nebbos&rsquo;s copyright, trademark, or attribution notices; may not use the Nebbos software to develop a competing product. PERMITTED USES — internal business operation, integration with the operator&rsquo;s own tooling via the documented MCP protocol, contribution to the Nebbos open-source components under the applicable OSS license. TERMINATION — the license terminates on the earlier of (a) expiration or termination of the MSA, (b) the operator&rsquo;s uncured material breach of the license after 30 days written notice, (c) the operator&rsquo;s written notice of termination. On termination, the operator ceases use of the Nebbos software within 30 days and either returns or certifies destruction of the Cradle per the Hardware Warranty.",
      },
      {
        id: "master-services",
        kind: "text-block",
        eyebrow: "04 · Master services",
        h2: "Support model, uptime targets, operator obligations.",
        body: "SUPPORT MODEL — Nebbos provides support for the nebbos.ai account plane, the Nebbos software, and the Cradle hardware. Support tiers, response SLAs, and escalation paths are set in the Support Terms; enterprise tier includes named-contact escalation and priority-queue triage. UPTIME — Nebbos targets 99.95% monthly availability for the nebbos.ai account plane (sign-in, tenant configuration, billing). Cradle-based substrate operates on the operator&rsquo;s host; its availability is not an uptime obligation of Nebbos. Nebbos publishes real-time status at /status and monthly availability reports at /trust. OPERATOR OBLIGATIONS — the operator organization is responsible for the physical security of issued Cradles, for the operator-side biometric enrollment, for revocation of departed operator credentials, and for the operator-side authorization policy that governs which tools the MCP mediates. Nebbos does not administer these on the operator&rsquo;s behalf.",
      },
      {
        id: "hardware-warranty",
        kind: "text-block",
        eyebrow: "05 · Hardware warranty",
        h2: "The Cradle ships under a separate agreement.",
        body: "Every Nebbos Cradle ships under a separate Purchase Agreement + Hardware Warranty. That instrument covers defect remediation, replacement on hardware failure, revocation on operator departure, and the biometric-enrollment ceremony that binds a Cradle to a named operator. Cradle warranty is 24 months against manufacturing defect. The Hardware Warranty is available on request via legal@nebbos.ai and ships with every Cradle. If the operator organization loses a Cradle, the recovery flow depends on the recovery posture the operator elected under /sovereignty §04 — vendor-mediated (Nebbos-side reissue with audit event landed in the client&rsquo;s trail) or user-quorum (Shamir 3-of-5 quorum of custodian Cradles; Nebbos-side cannot unlock).",
      },
      {
        id: "payments",
        kind: "text-block",
        eyebrow: "06 · Payments",
        h2: "How Nebbos invoices and how the operator pays.",
        body: "Pricing is published at /pricing. Enterprise engagements are invoiced under the MSA; self-serve tiers are billed automatically through the payment processor named in the Privacy Notice §08. Invoices are due within 30 days of receipt for enterprise engagements; disputes must be raised in writing within 30 days of receipt with sufficient detail for Nebbos to investigate. Nebbos does not charge for support tickets, incident escalations, or the exercise of data-subject rights under the Privacy Notice. The Cradle is a separate line item, invoiced at hardware cost plus a fair-margin markup published on the pricing page.",
      },
      {
        id: "acceptable-use",
        kind: "text-block",
        eyebrow: "07 · Acceptable use",
        h2: "What the operator may not do with the Nebbos software.",
        body: "The operator organization may not use the Nebbos software to (a) violate applicable law, (b) infringe on any third party&rsquo;s intellectual property or privacy rights, (c) transmit malware, worms, or other malicious code, (d) engage in autonomous decisioning that removes the named-human-approval gate that the substrate enforces at Layer 11, (e) circumvent the row-level client isolation at Layer 01, (f) tamper with the append-only audit trail at Layer 15, (g) misrepresent the provenance of a Pearl-generated artifact to a regulator, auditor, or counterparty. The full Acceptable Use Policy is published at /legal/acceptable-use.",
      },
      {
        id: "confidentiality",
        kind: "text-block",
        eyebrow: "08 · Confidentiality",
        h2: "Mutual obligations on confidential information.",
        body: "Each party protects the other party&rsquo;s confidential information with the same degree of care it uses to protect its own confidential information, and no less than reasonable care. Confidential information includes non-public technical, commercial, and operational information disclosed in connection with the MSA. Exclusions: information that is or becomes publicly available through no fault of the receiving party, was already lawfully in the receiving party&rsquo;s possession, was independently developed without reference to the disclosing party&rsquo;s confidential information, or is required to be disclosed by law or court order (in which case prompt notice must be given to the disclosing party to allow an objection). Obligations survive termination of the MSA for a period of five years.",
      },
      {
        id: "ip",
        kind: "text-block",
        ...
        h2: "Who owns what.",
        body: "NEBBOS-OWNED — Nebbos and its affiliates own the Nebbos software (all source, binaries, models, protocol specifications, brand marks, and documentation). The license granted under §03 does not transfer any ownership. OPERATOR-OWNED — the operator organization owns every byte of data its operators produce or ingest through the Nebbos software, including memory contents on the Cradle, tool-call payloads, approval records, tuned Pearl weights, and derived artifacts. This is a substrate guarantee, not a contractual concession — Cradle-resident data is architecturally inaccessible to Nebbos. FEEDBACK — if the operator provides Nebbos with feedback about the Nebbos software (bug reports, feature suggestions, product-direction commentary), Nebbos may incorporate the feedback into the Nebbos software without obligation, credit, or compensation, provided no operator-specific confidential information is included in the incorporated feedback.",
      },
      {
        id: "warranties",
        kind: "text-block",
        eyebrow: "10 · Warranties and disclaimers",
        h2: "What Nebbos warrants and what is disclaimed.",
        body: "NEBBOS WARRANTS that the Nebbos software will perform substantially in accordance with the published documentation for the term of the MSA, and that Nebbos has the right to grant the license granted under §03. NEBBOS DISCLAIMS to the maximum extent permitted by applicable law all other warranties, whether express or implied, including implied warranties of merchantability, fitness for a particular purpose, and non-infringement. The Nebbos software is provided as-is beyond the express warranty above. NEBBOS DOES NOT WARRANT that the Nebbos software will be uninterrupted, error-free, or that all defects will be corrected. The Cradle Hardware Warranty is a separate instrument (see §05).",
      },
      {
        id: "liability",
        kind: "text-block",
        eyebrow: "11 · Limitation of liability",
        h2: "The cap on damages.",
        body: "Neither party&rsquo;s aggregate liability under the MSA exceeds the total fees paid by the operator to Nebbos in the twelve months preceding the event giving rise to the liability. Neither party is liable for indirect, incidental, consequential, special, exemplary, or punitive damages, including lost profits, lost revenue, or lost data, regardless of the theory of liability. The cap does not apply to (a) the operator&rsquo;s payment obligations under §06, (b) breach of the confidentiality obligations under §08, (c) breach of the Acceptable Use Policy under §07, (d) willful misconduct or gross negligence, (e) indemnification obligations under §12, or (f) any liability that cannot be limited under applicable law.",
      },
      {
        id: "indemnification",
        kind: "text-block",
        eyebrow: "12 · Indemnification",
        h2: "Who defends and holds harmless whom.",
        body: "NEBBOS DEFENDS AND HOLDS HARMLESS the operator organization against any third-party claim that the Nebbos software as delivered infringes on that third party&rsquo;s intellectual property rights. If such a claim is threatened, Nebbos may at its option (a) procure the right to continue use, (b) modify the Nebbos software to eliminate the infringement without material loss of function, or (c) terminate the affected component and refund a prorated portion of prepaid fees. THE OPERATOR DEFENDS AND HOLDS HARMLESS Nebbos against any third-party claim arising from (a) the operator&rsquo;s use of the Nebbos software in violation of the MSA or applicable law, (b) the operator&rsquo;s data or content processed through the Nebbos software (Nebbos does not access it, but the operator holds it), (c) the operator&rsquo;s failure to secure Cradles issued to its operators. Standard indemnification procedure applies: prompt written notice, control of defense, cooperation of the indemnified party.",
      },
      {
        id: "dispute-resolution",
        kind: "text-block",
        eyebrow: "13 · Dispute resolution",
        h2: "Governing law + arbitration seat depend on the contracting entity.",
        body: "The MSA is governed by the law of the jurisdiction of the contracting Nebbos entity — Delaware for the parent Nebbos Technologies Corp, California for Nebbos.ai (US-tenant contracts), Serbia for Nebbos D.O.O. (Balkan-tenant contracts), Greece for the Greek EU-main-office (EU-tenant contracts, effective on incorporation). Disputes are resolved first by good-faith negotiation between named executive contacts for 30 days. If unresolved, disputes escalate to binding arbitration. Arbitration seat is JAMS Los Angeles under JAMS Comprehensive Rules for Nebbos.ai contracts; ICC Belgrade under ICC Rules for Nebbos D.O.O. contracts; ICC Athens under ICC Rules for Greek EU-main-office contracts. Class actions and class arbitration are waived to the maximum extent permitted by applicable law. Emergency injunctive relief remains available in any court of competent jurisdiction.",
      },
      {
        id: "notice-clauses",
        kind: "list-numbered",
        eyebrow: "14 · Notice clauses",
        h2: "Two operational-notification obligations.",
        deck: "Two clauses in the MSA govern operational-notification obligations. Both are pending counsel review; the SLA numbers below may shift based on that review.",
        items: [
          { title: "§8.6 — Client-workspace unavailability notification", body: "Nebbos notifies the enterprise operator&rsquo;s named admin within thirty minutes of a client-workspace unavailability event on the nebbos.ai account plane. The notification identifies affected surfaces, the degraded-capability class, and the recovery ETA. Cradle-based substrate is not covered by this clause — it runs on the operator&rsquo;s host and unavailability is out-of-scope for Nebbos to notice. The 30-minute SLA is pending counsel review; the reference specification is at reference_l2w_unavailable_tenant_contract_clause_notification_flow_spec_2026_09_18 in Nebbos&rsquo;s internal governance corpus." },
          { title: "§8.7 — Weekly ops-review", body: "Nebbos performs a weekly automated ops-review of the nebbos.ai account plane covering the operator&rsquo;s tenant. Findings above a defined severity threshold are surfaced to the enterprise operator&rsquo;s named admin within 24 hours of the review completion. Review scope, severity thresholds, and delivery format are set in the Support Terms." },
        ],
      },
      {
        id: "term-termination",
        kind: "text-block",
        eyebrow: "15 · Term and termination",
        h2: "How long the MSA runs and how it ends.",
        body: "The MSA runs for an initial term set in the countersigned order form (typically 12 or 36 months for enterprise). It renews automatically for successive terms of the same duration unless either party gives written notice of non-renewal at least 60 days before the end of the current term. Either party may terminate for cause on the other party&rsquo;s uncured material breach after 30 days written notice. Nebbos may suspend service on the operator&rsquo;s failure to pay undisputed invoices after 30 days written notice. On termination, the operator pays for services rendered through the termination date and receives an offboarding period of at least 90 days to export data, decommission Cradles, and cease use of the Nebbos software. The MSA is not terminated on Nebbos&rsquo;s acquisition — the acquisition-continuity clause preserves the operator&rsquo;s rights.",
      },
      {
        id: "survival",
        kind: "text-block",
        eyebrow: "16 · Survival",
        h2: "Which clauses outlive the MSA.",
        body: "The following clauses survive termination of the MSA for the period specified: confidentiality (§08, five years); limitation of liability (§11, indefinitely); indemnification (§12, indefinitely for indemnified events during the term); dispute resolution (§13, for any dispute arising during the term); intellectual property (§09, indefinitely); the operator&rsquo;s payment obligation for services rendered through the termination date. Every other clause terminates on the effective termination date.",
      },
      {
        id: "governing-entities",
        kind: "list-numbered",
        eyebrow: "17 · Governing entities and jurisdiction",
        h2: "Which Nebbos entity is on the other side of the paper.",
        deck: "The contracting Nebbos entity depends on where the operator organization sits, and determines the governing law and arbitration seat per §13.",
        items: [
          { title: "Nebbos.ai (US company)", body: "US operating entity. Counterparty for operators contracting from the United States. California governing law; JAMS Los Angeles arbitration seat." },
          { title: "Nebbos D.O.O. (Balkan operations)", body: "Serbian operating entity. Counterparty for operators contracting from Balkan markets. Serbian governing law; ICC Belgrade arbitration seat." },
          { title: "Greek company (EU main office)", body: "Greek operating entity, incorporation target November 2026. Counterparty for operators contracting from the European Union. Greek governing law; ICC Athens arbitration seat." },
          { title: "Nebbos Technologies Corp (Delaware parent)", body: "Owns the Nebbos trademark and licenses regional entities to distribute. Does not directly counterparty operator contracts; licenses the regional entities to do so." },
        ],
      },
      {
        id: "changes",
        kind: "text-block",
        eyebrow: "18 · Changes to these terms",
        h2: "How Nebbos amends the countersigned MSA.",
        body: "Countersigned MSAs amend only by written agreement of both parties. Nebbos gives at least 60 days advance notice of any proposed amendment to enterprise operators, and the operator may terminate the MSA at the end of the current term without penalty if it declines the amendment. Non-material changes to this summary page (clarification, wording, cross-reference updates) may be made without amendment to countersigned MSAs and are logged in /changelog. Every version of this page is retained and available on request via legal@nebbos.ai.",
      },
      {
        id: "contact",
        kind: "text-block",
        eyebrow: "19 · Contact",
        h2: "How to reach Nebbos about these terms.",
        body: "Contract negotiation, license questions, MSA amendments: legal@nebbos.ai. Enterprise procurement and order forms: enterprise@nebbos.ai. Support escalation and incident notification: engineering@nebbos.ai. Nebbos legal returns countersigned drafts within 24 hours during business hours; enterprise procurement responds within one business day.",
      },
      {
        id: "related",
        kind: "list-plain",
        ...
        h2: "Deeper reading.",
        items: [
          { title: "Privacy — Infrastructure notice + narrow account-metadata scope" },
          { title: "Acceptable Use — What the operator may not do" },
          { title: "Sovereignty — Data, model, and operational sovereignty by architecture" },
          { title: "Compliance — Status per framework" },
        ],
      },
  ...
  /* ═════════════════════════════════════════════════════════════════════
   * /legal/dpa — Retire-and-explain page
   * Reframed 2026-09-18 under doctrine `feedback_nebbos_is_infrastructure_not_
   * data_processor_no_dpa_framing_2026_09_18`. Route retained because buyer
   * bookmarks + external procurement references still resolve here; the page
   * explains why the DPA framing does not fit and offers the narrow-scope
   * account-metadata addendum for procurement checklists that require it.
   * Not linked from MarketingFooter (dropped 2026-09-18).
   * ─────────────────────────────────────────────────────────────────────── */
  "legal/dpa": {
    slug: "/legal/dpa",
    title: "Why you may not need a DPA from Nebbos",
    metaDescription: "Nebbos is infrastructure the customer owns and runs. The traditional Data Processing Agreement does not fit. Narrow-scope account-metadata addendum available for procurement checklists that require one.",
    sections: [
      {
        id: "hero",
        kind: "hero-paper",
        eyebrow: "00 · Notice · Draft — pending counsel review",
        h1: "Why you may not need a DPA from Nebbos.",
        deck: "Nebbos is infrastructure the customer owns and runs. The Cradle sits on your desk. Your memory lives on it. Your MCP mediates your own tool calls. Nebbos never processes your data. A Data Processing Agreement is the wrong instrument. This page explains what to use instead — and, if your procurement checklist still requires a DPA, how to obtain a narrow-scope one covering only the account-metadata surface.",
      },
      {
        id: "draft-status",
        kind: "text-block",
        eyebrow: "01 · Draft status",
        h2: "This page is a draft pending counsel review.",
        body: "The plain-language content on this page reflects Nebbos&rsquo;s ratified product doctrine and commercial posture. Counsel has not yet completed formal review. For the countersigned instrument covering a specific engagement — an SLA, an MSA, or a Narrow-Scope Account Metadata Addendum — write to legal@nebbos.ai. Nebbos legal returns countersigned drafts within 24 hours during business hours. The countersigned instrument governs, not this page.",
      },
      {
        id: "short-version",
        kind: "text-block",
        eyebrow: "02 · The short version",
        h2: "Nebbos is infrastructure. You own the data plane end-to-end.",
        body: "The Cradle ships to your operator&rsquo;s desk. The MCP binary runs on your operator&rsquo;s host. Your memory is encrypted at rest on the Cradle with a key derived from your operator&rsquo;s biometric. Every tool-call payload, every approval reasoning, every Pearl-generated artifact stays on your side. Nebbos sees opaque audit hashes to prove chain integrity and nothing else. The Cradle-based substrate does not have a data processor — the customer is the controller AND the processor. A Data Processing Agreement is a data-processor instrument. It does not fit.",
      },
      {
        id: "what-dpa-governs",
        kind: "text-block",
        eyebrow: "03 · What a DPA governs",
        h2: "GDPR Article 28, the controller/processor relationship, sub-processor onward flow.",
        body: "A Data Processing Agreement under GDPR Article 28 governs the vendor-customer relationship when the vendor processes personal data on behalf of the customer. The core mechanics are: (a) the vendor acts as processor; (b) the vendor may only process on documented instructions from the customer (controller); (c) the vendor imposes confidentiality on personnel; (d) the vendor takes appropriate technical and organizational measures; (e) the vendor engages sub-processors only with the customer&rsquo;s consent and passes the same obligations onward; (f) the vendor assists the customer with data-subject rights; (g) the vendor deletes or returns personal data at the end of the engagement. None of these mechanics fit Nebbos&rsquo;s architecture. Nebbos does not process customer operational data. Nebbos does not receive documented instructions to process it, because it never touches it. There is no onward flow to sub-processors, because there is nothing to flow onward. The substrate is architecturally incompatible with the processor-role premise.",
      },
      {
        id: "account-metadata-exception",
        kind: "text-block",
        eyebrow: "04 · Account metadata is the exception",
        h2: "The one narrow surface where a data-processing relationship exists.",
        body: "The nebbos.ai account plane is a normal web-application account-management surface. It touches work email, session cookies, product-plane telemetry, support-correspondence metadata, and payment metadata. That surface is disclosed in full in the Privacy Notice at /legal/privacy §03. On that narrow surface Nebbos is a data controller (for its own account-management purposes) and, in some framings, a processor for the operator organization&rsquo;s legal-entity metadata (name, address, billing counterparty). If your procurement team requires a signed data-processing instrument scoped strictly to that account-metadata surface, Nebbos legal countersigns a Narrow-Scope Account Metadata Addendum — machine-account-only, no attempt to characterize the Cradle-based substrate as a processor relationship. Request via legal@nebbos.ai.",
      },
      {
        id: "what-you-get-instead",
        kind: "list-numbered",
        eyebrow: "05 · What you get INSTEAD",
        h2: "The instruments that actually govern the relationship.",
        deck: "Every Nebbos engagement runs on these four instruments. A DPA is not among them, unless your procurement flow requires the narrow-scope addendum in §04.",
        items: [
          { title: "Software License Agreement (SLA)", body: "Grants the operator organization the license to run Nebbos software — MCP binary, Pearl runtimes, client software — on operator infrastructure. See /legal/terms." },
          { title: "Master Services Agreement (MSA)", body: "Governs the commercial relationship — payment, support, uptime for the account plane, warranties, dispute resolution. See /legal/terms." },
          { title: "Hardware Warranty + Purchase Agreement", body: "Separate instrument for the Cradle. Covers defect remediation, replacement, revocation on operator departure. Ships with the device." },
          { title: "Support Terms", body: "Response SLAs, escalation paths, incident-notification obligations. Referenced by the MSA." },
          { title: "Security attestations", body: "SOC 2 (in progress), ISO 27001:2022 (not yet held), EU AI Act Article 11 · Annex IV (in preparation). Authoritative status at /compliance and /security." },
        ],
      },
      {
        id: "sovereignty-guarantee",
        kind: "text-block",
        eyebrow: "06 · Sovereignty guarantee",
        h2: "When you leave, you take the substrate with you.",
        body: "This is the doctrine-level statement that replaces the standard DPA end-of-engagement clause. Because Nebbos does not hold your operational data, there is nothing on Nebbos infrastructure to delete at end-of-engagement. Your Cradle carries your memory, your tuned Pearl weights, your audit trail, your MCP capability policy. Every one of those exports as a machine-readable, verifier-signed artifact under the portability guarantee at /sovereignty §05. On offboarding you decommission the Cradle (return-and-destroy under the Hardware Warranty), export every artifact, and take the substrate with you to any successor. There is no departure-day scramble because there is no vendor-held data to reclaim.",
      },
      {
        id: "procurement-checklist-dpa",
        kind: "text-block",
        eyebrow: "07 · If your procurement blocker is checklist-only",
        h2: "The Narrow-Scope Account Metadata Addendum.",
        body: "Some enterprise procurement flows require a signed DPA regardless of vendor architecture. The Narrow-Scope Account Metadata Addendum is Nebbos&rsquo;s response to that. It covers only the account-plane touches enumerated in the Privacy Notice §03 — account identity, session cookies, product-plane telemetry, support-correspondence metadata, payment metadata. It executes Standard Contractual Clauses for international transfers where the contracting entity is EU-side, incorporates the sub-processor list from the Privacy Notice §08, and passes Article 28 obligations onward for that narrow scope. It does NOT attempt to characterize the Cradle-based substrate as a processor relationship, because it is not one. The addendum is a procurement-checklist instrument; substantive assurance for the operational data lives in the substrate itself, not in the paper.",
      },
      {
        id: "contact-legal",
        kind: "text-block",
        eyebrow: "08 · Contact for legal-team requests",
        h2: "How to obtain the narrow-scope addendum or discuss the framing.",
        body: "Requests for the Narrow-Scope Account Metadata Addendum, or discussion of the infrastructure-vs-processor framing with Nebbos legal: legal@nebbos.ai. Nebbos legal returns a countersigned draft within 24 hours during business hours. For enterprise procurement and MSA order forms: enterprise@nebbos.ai. If your compliance team wants a walkthrough of the architectural evidence for why Nebbos does not process customer data — the Cradle key-derivation ceremony, the MCP host-side execution model, the append-only audit-hash chain — request a technical briefing via legal@nebbos.ai and Nebbos schedules within one business day.",
      },
      {
        id: "changes",
        kind: "text-block",
        eyebrow: "09 · Changes",
        h2: "How Nebbos notifies operators of a change to this page.",
        body: "Material changes to the substance of this page — a change to the Narrow-Scope Account Metadata Addendum, a change to the governing-entity split, a change to the sub-processor list for the account plane — are notified to enterprise operators at least 30 days in advance by email and by banner on nebbos.ai. Non-material changes (clarification, wording, cross-reference updates) are logged at /changelog. Every version of this page is retained; earlier versions are available on request via legal@nebbos.ai.",
      },
      {
        id: "governing-entities",
        kind: "list-numbered",
        eyebrow: "10 · Governing entities",
        h2: "Which Nebbos entity signs a Narrow-Scope Account Metadata Addendum with you.",
        items: [
          { title: "Nebbos.ai (US company)", body: "US operating entity. Counterparty for US operators; California governing law; JAMS Los Angeles seat if disputed." },
          { title: "Nebbos D.O.O. (Balkan operations)", body: "Serbian operating entity. Counterparty for Balkan-market operators; Serbian governing law; ICC Belgrade seat." },
          { title: "Greek company (EU main office)", body: "Greek operating entity, incorporation target November 2026. Counterparty for EU operators; unqualified GDPR territorial scope; ICC Athens seat." },
        ],
      },
      {
        id: "contact",
        kind: "text-block",
        eyebrow: "11 · Contact",
        h2: "How to reach Nebbos about this page.",
        body: "For anything relating to the framing on this page or a Narrow-Scope Account Metadata Addendum request: legal@nebbos.ai. Nebbos legal returns countersigned drafts within 24 hours during business hours. Data-subject rights: privacy@nebbos.ai. Security-relevant questions: security@nebbos.ai.",
      },
      {
        id: "related",
        kind: "list-plain",
        ...
        items: [
          { title: "Privacy — Infrastructure notice + narrow account-metadata scope" },
          { title: "Terms — Software license + MSA + Hardware warranty + Support terms" },
          { title: "Sovereignty — Data, model, and operational sovereignty by architecture" },
          { title: "Compliance — Status per framework" },
        ],
      },
  ...
  /* ═════════════════════════════════════════════════════════════════════
   * /legal/subprocessors — Retire-and-explain page
   * Reframed 2026-09-18 under doctrine `feedback_nebbos_is_infrastructure_not_
   * data_processor_no_dpa_framing_2026_09_18`. Route retained because buyer
   * bookmarks + external references still resolve here; the page explains why
   * the SaaS sub-processor category does not apply, and lists the narrow set
   * of account-plane vendors. Not linked from MarketingFooter (dropped 2026-09-18).
   * ─────────────────────────────────────────────────────────────────────── */
  "legal/subprocessors": {
    slug: "/legal/subprocessors",
    title: "Nebbos does not have SaaS-scale sub-processors",
    metaDescription: "Nebbos is not a SaaS. Customer data lives on the Cradle. There is no full-SaaS sub-processor list to disclose — only the narrow account-plane vendors that keep nebbos.ai signed in and billed.",
    sections: [
      {
        id: "hero",
        kind: "hero-paper",
        eyebrow: "00 · Notice · Draft — pending counsel review",
        h1: "Nebbos doesn&rsquo;t have SaaS-scale sub-processors, because it isn&rsquo;t a SaaS.",
        deck: "A sub-processor list is a SaaS-vendor disclosure — the third parties the vendor hands your data to in the course of operating on your behalf. Nebbos never hands your data to anyone. Your data lives on your Cradle; your MCP mediates your own tool calls; your memory is encrypted with a key derived from your biometric. What appears below is the narrow set of infrastructure vendors that keep the nebbos.ai account plane running. That is the full disclosure.",
      },
      {
        id: "draft-status",
        kind: "text-block",
        eyebrow: "01 · Draft status",
        h2: "This page is a draft pending counsel review.",
        body: "The plain-language content on this page reflects Nebbos&rsquo;s ratified product doctrine and the current account-plane vendor stack. Counsel has not yet completed formal review; the vendor stack may narrow as products consolidate. For a countersigned instrument covering the account-metadata scope — a Narrow-Scope Account Metadata Addendum — write to legal@nebbos.ai. Nebbos legal returns a countersigned draft within 24 hours during business hours.",
      },
      {
        id: "infrastructure-model",
        kind: "text-block",
        eyebrow: "02 · The infrastructure model",
        h2: "Customer data never leaves the customer&rsquo;s Cradle.",
        body: "Every operator authorized above L1 carries a Nebbos-issued Cradle. The Cradle is a hardware device — FIPS 140-3 Level 3 encrypted storage with a biometric-gated key. Your memory sits on the Cradle. Your operator&rsquo;s tool-call payloads run through an MCP binary hosted on the Cradle. Your approval events land in an append-only audit trail written to storage your keys unlock. Nebbos infrastructure sees the opaque audit hashes needed to prove chain integrity and nothing else. Because nothing operational crosses to Nebbos infrastructure, there is nothing to hand onward to a sub-processor. The traditional SaaS sub-processor disclosure — a spreadsheet of third parties the SaaS vendor shares customer data with — has no analog here.",
      },
      {
        id: "account-plane-vendors",
        kind: "list-numbered",
        eyebrow: "03 · The narrow account-metadata vendor list",
        h2: "The vendors that keep nebbos.ai signed in and billed.",
        deck: "These vendors touch account-plane metadata only — the narrow scope enumerated in the Privacy Notice at /legal/privacy §03. They do not touch customer memory, tool-call payloads, or approval reasoning. Every one runs under a signed vendor agreement with confidentiality and appropriate technical and organizational measures.",
        items: [
          { title: "Authentication provider — WorkOS", body: "Enterprise SSO, directory sync, session management for the nebbos.ai account plane. SOC 2 Type II, ISO 27001. US and EU regions. Scope: work email, display name, session claim." },
          { title: "Web hosting + CDN", body: "Commercial hosting provider running the nebbos.ai marketing surfaces and account plane. US and EU regions. SOC 2, ISO 27001. Scope: static asset delivery, edge routing." },
          { title: "Transactional email", body: "Delivery provider for account-lifecycle email — sign-in links, receipts, breach notifications, support responses. SOC 2. Scope: work email, subject line, message body for lifecycle-triggered messages." },
          { title: "Observability", body: "Metrics + tracing + log aggregation for the nebbos.ai account plane only. Cradle-side telemetry stays on the Cradle. SOC 2, ISO 27001. Scope: account-plane request-response metadata, aggregated at the tenant level." },
          { title: "Payment processor", body: "When self-serve billing lands: card-processing vendor. PCI DSS Level 1. Full card numbers never touch Nebbos infrastructure. Scope: billing name, billing address, card last-four, receipt records." },
          { title: "Support-ticket system", body: "Inbox provider for legal@, security@, privacy@, engineering@, enterprise@, hello@ correspondence. Retention 24 months per Privacy Notice §07. Scope: sender email, subject, body, timestamp for support correspondence." },
        ],
      },
      {
        id: "notification-obligations",
        kind: "text-block",
        eyebrow: "04 · Changes we notify on",
        h2: "Advance notice, and what is not applicable.",
        body: "For the account-plane vendor list above, Nebbos gives enterprise operators at least 30 days advance notice of any change — new vendor added, existing vendor removed, scope of an existing vendor materially expanded. Notice is delivered by email to the account&rsquo;s work-email address and by banner on nebbos.ai when the operator&rsquo;s admin signs in. Enterprise operators may object to a proposed change within the notice period; where objection cannot be resolved, the operator may terminate the MSA at the end of the current term without penalty. For the Cradle-based substrate: no sub-processor notification obligation applies because there are no sub-processors in that path. Cradle firmware updates are governed by the Hardware Warranty; MCP binary updates by the Software License Agreement.",
      },
      {
        id: "machine-readable-feed",
        kind: "text-block",
        eyebrow: "05 · Machine-readable feed",
        h2: "A JSON endpoint at /subprocessors.json (planned).",
        body: "For enterprise compliance-tooling that ingests sub-processor disclosures machine-readably, Nebbos plans to ship a versioned JSON endpoint at /subprocessors.json. The endpoint delivers the account-plane vendor list above in a stable schema (name, scope, region, framework attestations, effective-from date), with 30-day advance-notice preview entries. Target ship: Sprint 3, Wave 5. Until then, the list on this page is the authoritative disclosure; version and effective-from date are logged at /changelog. If your compliance tooling requires the machine-readable feed today, request an interim CSV via legal@nebbos.ai.",
      },
      {
        id: "cradle-substrate-null",
        kind: "text-block",
        eyebrow: "06 · The Cradle-based substrate — deliberately null",
        h2: "Why there is no sub-processor list for the operational substrate.",
        body: "A reader familiar with SaaS-vendor sub-processor lists may expect this page to disclose the model providers, hosting providers, and storage providers the substrate itself runs on. That expectation does not hold because the substrate does not run on Nebbos infrastructure. Model calls run through the Nebbos MCP binary hosted on the operator&rsquo;s Cradle. Model provider selection (Anthropic, OpenAI, Google, self-hosted open-weights) is set in the operator&rsquo;s own capability policy, held on the Cradle. Storage for memory, audit trail, and Pearl weights sits on the Cradle or on operator-controlled storage that Nebbos keys cannot unlock. Nebbos does not have sub-processor visibility into these providers because Nebbos does not choose them, contract with them, or route customer data through them. The operator does.",
      },
      {
        id: "governing-entities",
        kind: "list-numbered",
        eyebrow: "07 · Governing entities",
        h2: "Which Nebbos entity contracts with the account-plane vendors.",
        deck: "Which regional operating entity is the counterparty to each account-plane vendor depends on the region and the contracting operator.",
        items: [
          { title: "Nebbos.ai (US company)", body: "Contracts with US-region vendors on the account plane. Vendor agreements executed under California law." },
          { title: "Nebbos D.O.O. (Balkan operations)", body: "Contracts with Balkan-region vendors and shared regional services. Vendor agreements executed under Serbian law." },
          { title: "Greek company (EU main office)", body: "On incorporation (target November 2026), contracts with EU-region vendors for the EU account plane. Vendor agreements executed under Greek law with Standard Contractual Clauses for international transfers where relevant." },
        ],
      },
      {
        id: "changes",
        kind: "text-block",
        eyebrow: "08 · Changes to this page",
        h2: "How Nebbos notifies operators of a change to this page.",
        body: "Any addition, removal, or material scope change to the account-plane vendor list is subject to the 30-day advance notice described in §04. Non-material changes to this page (clarification, wording, cross-reference updates) are logged at /changelog. Every version of this page is retained; earlier versions are available on request via legal@nebbos.ai.",
      },
      {
        id: "contact",
        kind: "text-block",
        eyebrow: "09 · Contact",
        h2: "How to reach Nebbos about the vendor list.",
        body: "Vendor-list questions, objections to a proposed change, requests for the interim CSV of the account-plane vendor list: legal@nebbos.ai. Security-relevant questions about a listed vendor: security@nebbos.ai. Nebbos legal responds within 24 hours during business hours.",
      },
      {
        id: "related",
        kind: "list-plain",
        ...
        items: [
          { title: "Privacy — Infrastructure notice + narrow account-metadata scope" },
          { title: "Terms — Software license + MSA + Hardware warranty + Support terms" },
          { title: "DPA — Why the SaaS DPA framing does not fit + narrow-scope addendum" },
          { title: "Sovereignty — Data, model, and operational sovereignty by architecture" },
          { title: "Security — Technical controls in depth" },
        ],
      },
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { title: "Hardware-attested identity on every request", body: "Every request carries an identity you can trace. Biometric + Cradle at the privileged tier; biometric + Cradle + enclave at the admin tier." },
          { title: "Classifier runs on your host, before egress", body: "The tier decision for every request happens on-Cradle. You set the policy. Attested, reviewable, one file." },
          { title: "Memory portability tested on every deploy", body: "The export path runs as part of the pipeline &mdash; not as an offboarding-day surprise. Weights, memory, routing, and audit trail export in shapes any successor substrate can import." },
          { title: "Audit trail your inspector-general reads directly", body: "Append-only chain, hash-signed, portable in machine-readable form. Your auditor reads the same records our engineers do." },
        ],
      },
      {
        id: "related",
