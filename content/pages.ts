...
export const PAGES = {
  ...
  about: {
    slug: "/about",
    title: "About · The operator platform your CISO can walk end to end",
    metaDescription:
      "Nebbos is a substrate, not a service. A Pearl per department, mediated through the MCP, run on hardware the operator holds. Portable in full the day you leave.",
    sections: [
      {
        id: "hero",
        kind: "hero-paper",
        eyebrow: "00 · About",
        h1: "A substrate, not a service.",
        deck: "Every enterprise has departments that would run better with a working brain of their own. Nebbos ships one per department — a Pearl mediated through the MCP, running on hardware the operator holds, portable in full the day they leave.",
      },
      {
        id: "facts",
        kind: "table-rows",
      ...
      },
      {
        ...
        h2: "A platform that watches the work you&rsquo;d rather not.",
    ...
    sections: [
      {
        ...
        kind: "hero-full-bleed",
        eyebrow: "Operations",
        h1: "The Pearl that stays up when the shift can't.",
    ...
    sections: [
      {
        ...
        kind: "hero-full-bleed",
        eyebrow: "Finance",
        h1: "The Pearl that closes on the day you said.",
    ...
    sections: [
      {
        ...
        kind: "hero-full-bleed",
        eyebrow: "People",
        h1: "The Pearl that reads why people leave before they say it.",
    ...
    sections: [
      {
        ...
        kind: "hero-full-bleed",
        eyebrow: "K12",
        h1: "The Pearl that runs the district behind the district.",
    ...
    sections: [
      {
        ...
        kind: "hero-full-bleed",
        eyebrow: "Healthcare",
        h1: "The Pearl that coordinates the care your chart already ordered.",
    ...
    sections: [
      {
        ...
        h1: "The Pearl that reads the desk, names the risk, signs the audit.",
    ...
    sections: [
      {
        ...
        h1: "The Pearl that catches the defect before the line stops.",
    ...
    sections: [
      {
        ...
        h1: "The Pearl every case answers to.",
  ...
  careers: {
    ...
    sections: [
      ...
      },
      {
        ...
        h2: "The two founding-engineer shapes scoped today.",
        deck: "Formal application intake opens when the first customer engagement is signed. Until then, the work is scoped and waiting — here is the shape of it, so the right person can decide whether the fit is real before we open the door.",
        items: [
