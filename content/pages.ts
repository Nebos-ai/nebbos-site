...
export const PAGES = {
    ...
    sections: [
      {
        ...
        h1: "Privacy Policy",
        deck: "How Nebbos collects, uses, retains, and returns customer data. The short version: client data belongs to the client, is portable to the client, and is never shared across clients.",
      },
    ],
  },
  "legal/terms": {
  ...
  "legal/dpa": {
    slug: "/legal/dpa",
    title: "Data processing · Nebbos is infrastructure, not a processor",
    metaDescription: "Nebbos is infrastructure the customer runs. Customer data never touches Nebbos servers — Cradle on customer desk, MCP on customer host, keys on customer biometric. DPA scope reduced to platform-account metadata; governed by the Privacy Policy.",
    sections: [
      {
        id: "hero",
        kind: "hero-paper",
        eyebrow: "00 · Legal · Data processing",
        h1: "Nebbos is infrastructure, not a data processor.",
        deck: "Customer data lives on the customer's Cradle, mediated by the customer's MCP, encrypted with keys derived from the customer's biometric. Nebbos never accesses it. The narrow processing that does happen — platform-account login, session cookies, product-usage analytics — is governed by the Privacy Policy at /legal/privacy.",
      },
      {
        id: "scope",
        kind: "text-block",
  ...
  "legal/subprocessors": {
    ...
    title: "Infrastructure vendors · Nebbos operates on",
    metaDescription: "Nebbos runs on hosting, DNS, observability, and payment vendors — the same commercial infrastructure any B2B site runs on. These vendors do not touch customer data (Cradle, MCP, memory); scope is limited to nebbos.ai platform-account operation.",
    sections: [
      {
        id: "hero",
        kind: "hero-paper",
        eyebrow: "00 · Legal · Infrastructure vendors",
        h1: "The vendors Nebbos runs on.",
        deck: "Hosting, DNS, observability, payment. The same commercial infrastructure any B2B site runs on. These vendors have no access to customer data — that lives on the customer's Cradle, mediated by the customer's MCP. The list here covers platform-account operation only. Notice of change to enterprise customers 30 days in advance.",
      },
    ],
  },
  "legal/cookies": {
