 ...
 *
 * Vocabulary rules (2026-09-11 run-layer north star, superseding 2026-08-23 "operating system" framing per reference_nebbos_north_star_run_layer_architecture):
 *   Use: run layer, executor, Pearl, metered, isolated, modular, architecture, Nebbos [Domain]
 *   Never: agent, agents, AI agent, bot, chatbot, assistant, copilot, tenant(s), multi-tenant
 ...
 *   Retracted claim patterns (do not resurrect — legal exposure): "SOC 2 Type II report available under NDA", "Annex IV pack available under NDA", "HIPAA BAA available", "Engineered to SOC 2 Type II and ISO 27001", "Auditors accept it as SOX-adequate", "Bessemer/Avante/SFAI Labs 2026 benchmark", "twenty-three-percent inference-of-revenue"
 *
 * Related registries:
