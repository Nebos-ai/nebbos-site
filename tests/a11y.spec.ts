...
const ROUTES = [
  ...
  "/products",
  "/products/platform",
  "/products/platform/guest",
  "/products/platform/host",
  "/products/platform/architect",
  "/products/app",
  "/products/app/guest",
  "/products/app/host",
  "/products/app/architect",
  "/products/mcp",
  "/products/mcp/guest",
  "/products/mcp/host",
  "/products/mcp/architect",
  "/products/cradle",
  "/products/cradle/guest",
  "/products/cradle/host",
  "/products/cradle/architect",
  "/solutions",
  "/pricing",
  "/demo",
  "/contact",
