...
if [ "$VIOLATIONS" -eq 0 ]; then
  ...
  echo "    customer-facing content. Use 'run layer', 'executor', 'Pearl',"
  echo "    'Nebbos [Domain]', 'architecture' instead."
  echo "    (2026-09-11: 'operating system' + 'company brain' superseded by"
  echo "    the run-layer north star; do not resurrect.)"
