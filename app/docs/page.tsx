    ...
    entries: [
      {
        ...
        lede: "Hash-chained, append-only. What lands in the log, what verifies it, how an inspector reads it end to end.",
        status: "planned",
      },
      {
        slug: "row-level-isolation",
        title: "Row-level isolation",
        lede: "How the database refuses to return a row that doesn't carry the caller's identity. Not enforced by the app.",
        status: "planned",
      },
      {
        slug: "portability",
        title: "Portability & export",
        lede: "Export runs on every deploy. How to run it, what comes out, how to verify it.",
        status: "planned",
      },
      {
